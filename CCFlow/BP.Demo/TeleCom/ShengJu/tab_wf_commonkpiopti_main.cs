    ...
    public class tab_wf_commonkpiopti_main : EntityOID
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBInt(tab_wf_commonkpiopti_mainAttr.WorkID, 0, "工作ID", true, false);

                map.AddTBString(tab_wf_commonkpiopti_mainAttr.fk_flow, null, "流程编号", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_title, null, "标题", true, false, 0, 200, 10);

                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_no, null, "单据编号", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_category, null, "流程类别", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_priority, null, "紧急程度", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_send_user, null, "发起人", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_send_department, null, "发起人部门", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_send_time, null, "发起时间", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.wf_send_phone, null, "发起人电话", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpiopti_mainAttr.techology, null, "技术信息", true, false, 0, 200, 10);
