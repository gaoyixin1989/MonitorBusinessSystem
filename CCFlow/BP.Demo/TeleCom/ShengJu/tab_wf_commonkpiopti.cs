    ...
    public class tab_wf_commonkpiopti : EntityOID
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBInt(tab_wf_commonkpioptiAttr.ParentWorkID, 0, "父流程ID", true, false);

                map.AddTBInt(tab_wf_commonkpioptiAttr.wf_priority, 0, "紧急程度", true, false);

                map.AddTBString(tab_wf_commonkpioptiAttr.tab_wf_commonkpiopti_main, null, "关联省局ID", true, false, 0, 200, 10);

                map.AddTBString(tab_wf_commonkpioptiAttr.region_id, null, "单据编号", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptiAttr.wf_category, null, "类别", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptiAttr.wf_no, null, "单据编号", true, false, 0, 200, 10);

                map.AddTBString(tab_wf_commonkpioptiAttr.wf_priority, null, "紧急程度", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptiAttr.wf_send_user, null, "发起人", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptiAttr.wf_send_department, null, "发起人部门", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptiAttr.wf_send_time, null, "发起时间", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptiAttr.wf_send_phone, null, "发起人电话", true, false, 0, 200, 10);
