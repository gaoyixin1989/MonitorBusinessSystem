    ...
    public class tab_wf_commonkpioptivalue : EntityOID
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBInt(tab_wf_commonkpioptivalueAttr.WorkID, 0, "工作ID", true, false);
                map.AddTBInt(tab_wf_commonkpioptivalueAttr.ParentWorkID, 0, "父节点ID", true, false);

                map.AddTBString(tab_wf_commonkpioptivalueAttr.fk_flow, null, "fk_flow", true, false, 0, 200, 10);
                map.AddTBString(tab_wf_commonkpioptivalueAttr.fuzeren, null, "负责人", true, false, 0, 200, 10);
