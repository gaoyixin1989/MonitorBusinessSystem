...
namespace BP.WF
{
   public class WeiXin
    {
        private string appid = "wx8eac6a18c5efec30";
        private string appsecret = "KfFkE9AZ3Zp09zTuKvmqWLgtLj-_cHMPTvV992apOWgSKJHcbjpbu1jYVXh7gI7K";
        public string getAccessToken()
       {
           ...
           try
           {
               ...
               AT = ParseFromJson<AccessToken>(str);
               reader.Dispose();
               reader.Close();
       ...
       public MessageErrorModel PostWeiXinMsg(StringBuilder sb)
       {
           ...
           m = ParseFromJson<MessageErrorModel>(wxStr);
           return m;
       }
       /// <summary>
       /// POST方式请求 微信返回信息
