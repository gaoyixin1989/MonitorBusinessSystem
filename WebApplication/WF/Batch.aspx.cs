    ...
    public partial class WF_BatchSmall :BP.Web.WebPage
    {
        ...
        public int BindNodeList()
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                this.Pub1.Add("<div style='margin-left:30px;margin-top:20px;font-size:14px;' ><img src='/WF/Img/info.png' align='middle' />当前没有批处理的工作......</div>");
                return 0;
            }
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                this.Pub1.Add("<img src='/WF/Img/info.png' align='middle' />当前没有批处理的工作.");
