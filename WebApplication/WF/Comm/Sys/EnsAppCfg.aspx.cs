...
public partial class CCFlow_Comm_Sys_EnsAppCfg : BP.Web.WebPageAdmin
{
    ...
    public void BindSelectCols()
    {
        ...
        this.UCSys1.AddTR();
        this.UCSys1.AddTDTitle("style='width:60px;text-align:center'", "序");
        this.UCSys1.AddTDTitle("style='width:40px;text-align:center'", "<input type='checkbox' onclick=\"javascript:$('input[type=checkbox]').attr('checked', this.checked)\" />");
        this.UCSys1.AddTDTitle("列");
