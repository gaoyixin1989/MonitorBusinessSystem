...
namespace CCFlow.AppDemoLigerUI
{
    public partial class Default : BasePage
    {
        ...
        public string GetGpmMenu()
        {
            ...
            //sbXML.Append("<a id='a1' class='l-link' href='javascript:f_addTab(\"a1\",\"部门类型\",\"../../Comm/Search.aspx?EnsName=BP.GPM.DeptTypes\")'>");
            //sbXML.Append("<img class='img-menu' align='middle' alt='' src='Img/Menu/Start.png' />部门类型</a>");

            sbXML.Append("<a id='a2' class='l-link' href='javascript:f_addTab(\"a2\",\"岗位类型\",\"../../Comm/Search.aspx?EnsName=BP.GPM.StationTypes\")'>");
            sbXML.Append("<img class='img-menu' align='middle' alt='' src='Img/Menu/Start.png' />岗位类型</a>");
            sbXML.Append("<a id='a3' class='l-link' href='javascript:f_addTab(\"a3\",\"岗位\",\"../../Comm/Search.aspx?EnsName=BP.GPM.Stations\")'>");
            sbXML.Append("<img class='img-menu' align='middle' alt='' src='Img/Menu/Start.png' />岗位</a>");
            sbXML.Append("<a id='a4' class='l-link' href='javascript:f_addTab(\"a4\",\"职务维护\",\"../../Comm/Search.aspx?EnsName=BP.GPM.Dutys\")'>");
