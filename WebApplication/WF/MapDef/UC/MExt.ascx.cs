...
public partial class WF_MapDef_UC_MExt : BP.Web.UC.UCBase3
{
    ...
    public void Edit_ActiveDDL()
    {
        ...
        this.Pub2.AddTableNormal();
        //this.Pub2.AddCaptionLeft(this.Lab);
        this.Pub2.AddTRGroupTitle(3, this.Lab);
        ...
        this.Pub2.AddTR();
        this.Pub2.AddTDGroupTitle("colspan=3", "联动方式");
        this.Pub2.AddTREnd();
        ...
        this.Pub2.Add("在下面文本框中输入一个SQL,具有编号，标签列，用来绑定下从动下拉框。<br />");
        ...
        //this.Pub2.AddFieldSet(rb);
        this.Pub2.Add("主菜单是编号的是从动菜单编号的前几位，不必联动内容。<br />");
