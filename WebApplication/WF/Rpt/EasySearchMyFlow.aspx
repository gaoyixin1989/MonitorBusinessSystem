<%@ Page Title="我的流程" Language="C#" MasterPageFile="~/WF/Rpt/EasySearch.Master" AutoEventWireup="true" CodeBehind="EasySearchMyFlow.aspx.cs" Inherits="CCFlow.WF.Rpt.EasySearchMyFlow" %>
...
<%
    ...
    {
        html += "<li><a href='/WF/Comm/Search.aspx?EnsName=BP.WF.Data.MyStartFlows&FK_Flow=" + dr["FK_Flow"] + "&WFSta=All&TSpan=All' >" + dr["FlowName"] + "(" + dr["Num"] + ")</a></li>";
    }
    html += "</ul>";
%>
<%=html %>
...
<%
    ...
    foreach (System.Data.DataRow dr in dt.Rows)
    {
        html += "<li><a href='/WF/Comm/Search.aspx?EnsName=BP.WF.Data.MyFlows&FK_Flow=" + dr["FK_Flow"] + "&WFSta=1&TSpan=All' >" + dr["FlowName"] + "(" + dr["Num"] + ")</a></li>";
    }
    html += "</ul>";
%>
<%=html %>
