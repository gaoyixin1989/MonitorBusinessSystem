...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .menulist li.over .menuitem-l{background:url('../css/index/menuitem.gif') repeat-x 0px -24px; width:2px; height:24px; position:absolute; left:0; top:0;}
        .menulist li.over .menuitem-r{background:url('../css/index/menuitem.gif') repeat-x -1px -24px; width:2px; height:24px; position:absolute; right:0; top:0;}
    </style>
    <!--CSS样式加载-->
...
<body>
    <div id="headBody" style="width:100%">
        <div position="top">
            <div class="header">
                <!-- header start -->
                <div class="headerInner">
                    <span>
                        <p>
                            欢迎您，<asp:Label runat="server" ID="lbWecomeUserName" Visible="false"></asp:Label> <%=LogInfo.UserInfo.REAL_NAME %><a href="#">设置</a>|<a id="div_logout" href="#">退出系统</a></p>
                    </span>
                </div>
            </div>
        </div>
        <div position="center" id="Div1"> 
    ...
    <div id="mainbody" style="width:100%; margin-left:5px;">
        <!--左边开始-->
