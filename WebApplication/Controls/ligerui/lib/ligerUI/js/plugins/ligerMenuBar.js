...
(function ($)
{
    ...
    $.ligerui.controls.MenuBar.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {
            var g = this, p = this.options;
            var ditem = $('<div class="l-menubar-item l-panel-btn"><span style="padding-left: 15px;"></span><div class="l-panel-btn-l"></div><div class="l-panel-btn-r"></div><div class="l-menubar-item-down"></div></div>');
