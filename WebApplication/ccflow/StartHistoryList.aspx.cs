...
public partial class ccflow_StartHistoryList : PageBase
{
    ...
    protected string getHisotryList()
    {
        ...
        string info = CCFlowFacade.GetEmpStartHistory(user.USER_NAME, Request["flowId"].ToString(), queryParams.ToArray(), page, pageSize);
