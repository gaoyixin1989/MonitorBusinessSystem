<%@ Page Language="C#" AutoEventWireup="True" Inherits="Sys_WF_WFShowStepImg" Codebehind="WFShowStepImg.aspx.cs" %>
...
<body>
    ...
    <div id="divTaskInfo" runat="server">
        <table width="100%">
            ...
            <tr>
                <td>
                    委托单号： 2013000000010001
                </td>
            </tr>
            <tr>
                <td>
                    项目名称：秦皇岛同和热电有限公司2013年度常规监测;排污许可证监测
                </td>
            </tr>
            <tr>
                <td>
                    启动时间：2013-05-10 13:00:59
                </td>
            </tr>
            <tr>
                <td colspan="100%">
