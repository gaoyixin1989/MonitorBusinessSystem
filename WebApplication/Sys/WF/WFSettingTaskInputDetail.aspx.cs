...
namespace n23
{
    ...
    public partial class Sys_WF_WFSettingTaskInputDetail : PageBaseForWF
    {
        ...
        protected void SetRdbtnLstOper()
        {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(WF_TASK_ID.Value))
            {
                ...
                this.Alert("添加成功");
                string strMessage = LogInfo.UserInfo.USER_NAME + "增加环节:" + setStep.WF_TASK_ID + " 成功";
                (this.Page as PageBase).WriteLog(i3.ValueObject.ObjectBase.LogType.WFAddSettingInfo, "", strMessage);
                //日志记录
            }
            else
            {
                ...
                string strMessage = LogInfo.UserInfo.USER_NAME + "修改环节:" + setStep.WF_TASK_ID + " 成功";
