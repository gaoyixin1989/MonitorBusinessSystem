<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Sys_Duty_UserDutySetting" Codebehind="UserDutySetting.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="UserDutySetting.js" type="text/javascript"></script>
    </asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    ...
    <div id="layout1" style="text-align:left">
        <div position="center"  title="">
            <div   id="navtab1"  position="center"> 
                <div tabid="home" title="分析岗位职责" lselected="true"   style="height:600px">
                    <div id="maingrid3"></div>
                </div>
                <div  title="采样岗位职责" style="height:600px">
                    <iframe frameborder="0" name="showmessage" src="DutySettingPage.aspx"></iframe>
                </div>
                <div  title="其他岗位职责" style="height:600px">
                    <iframe frameborder="0" name="showmessage" src="DutySettingOther.aspx"></iframe>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="tabletool" style="margin-left:37px;">
                    <tr>
                        <td  align="center" valign="top" rowspan="4">
                             <b>
                             未选择项目</b>
                        <select size="20" name="listLeft" multiple="multiple" id="listLeft"  title="双击可实现右移" 
