...
$(function () {
    $("#layout1").ligerLayout({ height: '100%', onHeightChanged: f_heightChanged });
    ...
    var isAddNew = false;
    tab = $("#navtab1").ligerTab({ height: bodyHeight, contextmenu: false });
    ...
    function moveleft() {
        ...
        //判断是否为监测类别，如果是则单独执行保存删除方法
        //        if ($("#listRight option:selected").text() == '所有(' + selectComboxText + '类)') {
        //            moveAllId += $("#listRight option:selected").val() + ";";
        //            isAllMonitor = true;
        //        }
        //        else {
        //            moveid += $("#listRight option:selected").val() + ";";
        //        }
