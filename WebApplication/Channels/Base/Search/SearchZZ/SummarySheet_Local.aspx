<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Base_Search_SearchZZ_SummarySheet_Local" Codebehind="SummarySheet_Local.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="SummarySheet_Local.js" type="text/javascript"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    <div id="layout1" style="text-align: left">
        ...
        <div position="center" title="监测结果">
    ...
    <div id="sheetType" style="display: none;">
        <form id="sheetTypeForm" method="post"> </form>
    </div>
</asp:Content>
