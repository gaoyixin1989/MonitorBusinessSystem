<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Base_Search_SearchZZ_ResultLogInfo" Codebehind="ResultLogInfo.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="ResultLogInfo.js" type="text/javascript"></script>
    <script src="../../../../Scripts/comm.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    <div id="layout1" style="text-align:left">
        <div position="center"  title="数据可追溯性">
            <div id="resultLogGrid"></div>
        </div>
    </div> 
</asp:Content>
