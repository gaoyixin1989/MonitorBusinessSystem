var objGrid = null;
var url = "AnalysisTimeSearch.aspx";
...
$(document).ready(function () {
    ...
    objGrid = $("#grid").ligerGrid({
        ...
        columns: [
                ...
                { display: '样品名称', name: 'SAMPLE_NAME', minWidth: 120 },
                { display: '监测项目', name: 'ITEM_NAME', minWidth: 140 },
                { display: '分析负责人', name: 'REAL_NAME', minWidth: 140 },
                { display: '要求完成时间', name: 'ASKING_DATE', minWidth: 140 },
                { display: '实际完成时间', name: 'FINISH_DATE', minWidth: 140 },
