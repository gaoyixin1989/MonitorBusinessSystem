...
function showDetailSrh() {
    ...
    function search() {
        ...
        taskGrid.set('url', "TaskSrh.aspx?Action=selectTask&SrhContractType=" + SrhContractType + "&SrhTICKET_NUM=" + SrhTICKET_NUM + "&SrhProjectName=" + SrhProjectName + "&SrhYear=" + SrhYear);
    }
