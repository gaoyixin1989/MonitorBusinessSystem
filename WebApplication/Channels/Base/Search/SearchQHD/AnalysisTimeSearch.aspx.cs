...
public partial class Channels_Base_Search_SearchQHD_AnalysisTimeSearch : PageBase
{
    ...
    private string GetData()
    {
        ...
        int intTotalCount = new TMisMonitorResultAppLogic().GetResultCount(StartTime, EndTime, HEAD_USERID, TICKET_NUM, OverTime);
        DataTable result = new TMisMonitorResultAppLogic().SearchDataEx(StartTime, EndTime, HEAD_USERID, TICKET_NUM, OverTime,pageIndex, pageSize);
