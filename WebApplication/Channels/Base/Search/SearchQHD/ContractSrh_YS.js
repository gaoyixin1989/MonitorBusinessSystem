// Create by 潘德军 2013.7.1  "综合查询--委托书查询--验收项目负责人"功能
// Create by 潘德军 2013.7.1  "综合查询--委托书查询--验收项目负责人"功能
...
$(document).ready(function () {
    ...
    contractGrid = $("#contractGrid").ligerGrid({
        ...
        title: "委托书信息",
        url: 'ContractSrh_YS.aspx?Action=SelectContract',
        ...
        onContextmenu: function (parm, e) {
            ...
            if (subTaskGrid)
                subTaskGrid.set('url', "ContractSrh_YS.aspx?Action=selectsubTask&task_id=null");
...
function showDetailSrh() {
    if (detailWinSrh) {
        ...
        mainform.ligerForm({
            ...
            fields: [
                      ...
                      { display: "项目名称", name: "srhProjectName", newline: true, type: "text" }
                    ]
        });
    ...
    function search() {
        ...
        contractGrid.set('url', "ContractSrh_YS.aspx?Action=SelectContract&SrhContractCode=" + SrhContractCode + "&SrhProjectName=" + SrhProjectName + "&SrhYear=" + SrhYear);
    }
...
function showAll() {
    contractGrid.set('url', "ContractSrh_YS.aspx?Action=SelectContract");
}
...
function showTaskGrid(strContractID) {
    ...
    menuTask = $.ligerMenu({ width: 120, items:
            ...
            { id: 'report', text: '报告', click: downloadReport, icon: 'pager' },
            { id: 'task', text: '执行情况', click: showTaskStep_QHD, icon: 'role' }
            ]
    });
    ...
    taskGrid = $("#taskGrid").ligerGrid({
        ...
        title: "",
        url: 'ContractSrh_YS.aspx?action=selectTask&contract_id=' + strContractID,
        dataAction: 'server', //服务器排序
...
function showSubTaskGrid(strTaskId) {
    ...
    menuSubTask = $.ligerMenu({ width: 120, items:
            ...
            { id: 'subtask', text: '执行情况', click: showTaskStep, icon: 'role' }
            ]
    });
    ...
    subTaskGrid = $("#subTaskGrid").ligerGrid({
        ...
        title: "",
        url: 'ContractSrh_YS.aspx?action=selectsubTask&task_id=' + strTaskId,
        dataAction: 'server', //服务器排序
        usePager: false,       //服务器分页
        pageSize: 5,
        alternatingRow: false,
