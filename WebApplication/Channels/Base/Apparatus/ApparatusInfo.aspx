<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Masters/SearchEx.master" Inherits="Channels_Base_Apparatus_ApparatusInfo" Codebehind="ApparatusInfo.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="ApparatusInfo.js" type="text/javascript"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    ...
    <div id="layout1">
        <div position="top" title="仪器设备">
            <div id="apparatusInfoGrid">
            </div>
        </div>
        <div position="left" title="仪器资料">
            <div id="apparatusDocumentGrid">
            </div>
        </div>
        <div position="right" title="检定证书">
            <div id="apparatusCertificGrid">
            </div>
        </div>
    </div>
</asp:Content>
