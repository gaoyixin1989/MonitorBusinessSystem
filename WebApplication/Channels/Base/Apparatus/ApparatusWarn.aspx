<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Masters/SearchEx.master" Inherits="Channels_Base_Apparatus_ApparatusWarn" Codebehind="ApparatusWarn.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="ApparatusWarn.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var topHeight = $(window).height() / 2;

            $("#layout1").ligerLayout({ allowLeftCollapse: false, allowRightCollapse: false, height: "100%" });
        });
    </script>
</asp:Content>
