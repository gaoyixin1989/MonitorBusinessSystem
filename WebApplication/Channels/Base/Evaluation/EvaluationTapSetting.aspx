<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Base_Evaluation_EvaluationTapSetting" Codebehind="EvaluationTapSetting.aspx.cs" %>
...
<head runat="server">
   ...
   <link rel="stylesheet" href="../../../Controls/zTree3.4/css/divuniontable.css" type="text/css"/>
    ...
    <script src="EvaluationTapSetting.js" type="text/javascript"></script>
    	<style type="text/css">
...
<div class="l-loading" style="display:block" id="pageloading"></div>
 <table cellpadding="0" cellspacing="0" class="tabletool" >
             <tr>
                <td align="center">
                <div>
                 检 索<input type="text" value="" id="txtSeach" class="l-text l-text-editing" onkeyup="javascript:txtSeachOption();"; style=" margin-left:4px;" /> <br />
                <b style="margin-top:4px;">未选监测项目</b>
            <select size="10" name="listLeft" multiple="multiple" id="listLeft"  class="searcha" style="width:170px;"  title="双击可实现右移"> 
            </select> 
            </div>
                </td>
                ...
                <td  align="center" class="l-table-edit-td">&nbsp;</td>
                <td align="center"> 
                    <b style="margin-top:26px;">已选监测项目</b>
                <select size="10" name="listRight" multiple="multiple" id="listRight"  class="searcha" style="width:170px;"  title="双击可实现左移"> 
                </select>
        </td>
            </tr>
</table>
