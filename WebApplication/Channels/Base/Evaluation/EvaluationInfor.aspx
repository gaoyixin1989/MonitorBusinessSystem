<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Base_Evaluation_EvaluationInfor" Codebehind="EvaluationInfor.aspx.cs" %>
...
<%@ Register TagPrefix="Webdiyer" Namespace="Wuqi.Webdiyer" Assembly="AspNetPager" %>
 ...
 <asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="../../../Controls/ligerui/lib/jquery-validation/validate.js" type="text/javascript"></script>
     <script src="EvaluationInfor.js" type="text/javascript"></script>
</asp:Content>
...
<div class="l-loading" style="display:block" id="pageloading"></div>
    ...
    <div id="detail" style="display:none;">
        <div id="editMonitorTypeform" ></div> 
    </div>
