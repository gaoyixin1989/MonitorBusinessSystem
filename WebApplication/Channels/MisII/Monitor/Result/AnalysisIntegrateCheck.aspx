<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_MisII_Monitor_Result_AnalysisIntegrateCheck"
    CodeBehind="AnalysisIntegrateCheck.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="AnalysisIntegrateCheck.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#layout1").ligerLayout({ topHeight: 200, leftWidth: '22%', rightWidth: '78%', allowLeftCollapse: false, allowRightCollapse: false, height: 760 });
            $("#layout2").ligerLayout({ topHeight: 180, leftWidth: '55%', rightWidth: '45%', allowLeftCollapse: false, allowRightCollapse: false, height: 510 });
        });
    </script>
</head>
<body style="padding: 0px; overflow: hidden; width: 99%; height: 100%; overflow-y: auto;">
    ...
    <input id="hidResultIDs" runat="server" type="hidden" />
