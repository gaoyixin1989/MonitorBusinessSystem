<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_MisII_Report_ReportAtt" Codebehind="ReportAtt.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="ReportAtt.js" type="text/javascript"></script>
    <title></title>
        ...
        <div tabid="home" title="报告生成" lselected="true" style="height: 100%">
            ...
            <div class="l-form">
                ...
                <ul>
                    ...
                    <li>
                        <a id="btnFiledownLoad" href="#">报告下载</a>
                    </li>
                    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
                    <li id="btnup">
                        <a id="btnFileUp" runat="server" href="javascript:">报告上传</a>
                    </li>
                </ul>
                <ul>
                    <li>
