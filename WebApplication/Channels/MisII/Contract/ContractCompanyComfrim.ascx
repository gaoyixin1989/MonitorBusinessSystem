<%@ Control Language="C#" AutoEventWireup="True" Inherits="Channels_MisII_Contract_ContractCompanyComfrim" Codebehind="ContractCompanyComfrim.ascx.cs" %>
...
<input type="text" id="AddressFrim" name="AddressFrim" class="l-text l-text-editing" style="width:350px; float:left;"  /> 
