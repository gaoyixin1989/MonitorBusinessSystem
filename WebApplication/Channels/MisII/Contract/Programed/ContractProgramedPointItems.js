...
var MonitorTypeId = "";
var isView = false, tabFirst = true;

$(document).ready(function () {
    var strdivImg = '<img src="../../../../Controls/ligerui/lib/ligerUI/skins/icons/communication.gif"  alt="监测点位信息"/><span>监测点位信息</span>';
...
function CreateDiv() {
    $.ajax({
        ...
        type: "POST",
        url: "../../../Mis/Contract/MethodHander.ashx?action=GetContractMonitorType&strContratId=" + task_id + "",
    ...
    if (vContractMonitorItems.length > 0) {
        ...
        newDiv += '<iframe frameborder="0" name="showmessagefgfgf" src= "../../ProcessMgm/ProcessMgm.aspx?strContratId=' + task_id + '"></iframe>';
        newDiv += '</div>';
        ...
        for (var i = 0; i < vContractMonitorItems.length; i++) {
            ...
            if (i == 0) {
                ...
                newDiv += '<iframe frameborder="0" name="showmessage' + MonitorTypeId + '" src= "../ProgramCreate/ContractCheckTab.aspx?strContratId=' + task_id + '&strMonitorType=' + MonitorTypeId + '&strCompanyIdFrim=' + vContractInfor[0].TESTED_COMPANY_ID + '&strProject=' + vContractInfor[0].PROJECT_NAME + '&strContractTypeId=' + vContractInfor[0].CONTRACT_TYPE + '&isView=' + isView + ' &strContractCode=' + vContractInfor[0].CONTRACT_CODE + '"></iframe>';
                newDiv += '</div>';
            }
