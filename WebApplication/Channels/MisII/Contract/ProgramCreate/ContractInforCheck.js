...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "../../../Mis/Contract/MethodHander.ashx?action=GetWebConfigValue&strKey=ConstIdent",
    ...
    $.ajax({
        ...
        async: false, //设置是否为异步加载,此处必须
        type: "POST",
        url: "../../../Mis/Contract/MethodHander.ashx?action=GetWebConfigValue&strKey=ConstUrl",
        contentType: "application/text; charset=utf-8",
        dataType: "text",
        success: function (data) {
            if (data != "") {
    ...
    $.ajax({
        ...
        async: false, //设置是否为异步加载,此处必须
        type: "POST",
        url: "../../../Mis/Contract/MethodHander.ashx?action=GetHidConstStatus",
        contentType: "application/text; charset=utf-8",
        dataType: "text",
        success: function (data) {
            if (data != "") {
    ...
    function SaveConstData(strRequestdata) {
        $.ajax({
            ...
            async: false, //设置是否为异步加载,此处必须
            type: "POST",
            url: "../../../Mis/Contract/MethodHander.ashx?action=UpdateConstractFeeCount&strContratId=" + strContratId + strRequestdata,
            contentType: "application/text; charset=utf-8",
            dataType: "text",
            success: function (data) {
                if (data != "") {
    ...
    $.ajax({
        ...
        async: false, //设置是否为异步加载,此处必须
        type: "POST",
        url: "../../../Mis/Contract/MethodHander.ashx?action=GetDict&type=RPT_WAY",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            if (data != null) {
...
function CreateDiv() {
    ...
    $.ajax({
        ...
        async: false, //设置是否为异步加载,此处必须
        type: "POST",
        url: "../../../Mis/Contract/MethodHander.ashx?action=GetContractMonitorType&strContratId=" + strContratId + "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            if (data != null) {
    ...
    if (vContractMonitorItems.length > 0) {
        ...
        newDiv += '<iframe frameborder="0" name="showmessagefgfgf" src= "../../ProcessMgm/ProcessMgm.aspx?strPlanId=' + strContratId + "tempPlanIdOfConract" + '"></iframe>';
        newDiv += '</div>';
...
//    });
//}
function ExportContractFee() {
    $.ligerDialog.confirm('确定导出委托监测费用明细？\r\n', function (yes) {
        if (yes == true) {
            $("#btnExport_QY_FEE").click();
        }
        else {
        }
    });
