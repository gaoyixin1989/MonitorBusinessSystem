<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_MisII_Contract_ProgramCreate_ContractInfor" Codebehind="ContractInfor.aspx.cs" %>

<%@ Register TagName="UserAdd" TagPrefix="UC" Src="~/Channels/MisII/Contract/ContractCompanyAdd.ascx" %>
<%@ Register TagName="UserComfrim" TagPrefix="UC" Src="~/Channels/MisII/Contract/ContractCompanyComfrim.ascx" %>
<%@ Register TagName="UserContratSelect" TagPrefix="UC" Src="~/Channels/MisII/Contract/ContratTypeSelect.ascx" %>
<%@ Register TagName="UserContratCheck" TagPrefix="UC" Src="~/Channels/MisII/Contract/ContractInforCheck.ascx" %>
<%@ Register TagName="UserContratSubmit" TagPrefix="UC" Src="~/Channels/MisII/Contract/ContractInforSubmit.ascx" %>
<%@ Register TagName="UserContractOtherInfor" TagPrefix="UC" Src="~/Channels/MisII/Contract/ContractOtherInfor.ascx" %>
...
<asp:Button ID="btnExport_QY_FEE" runat="server" Text="" onclick="btnExport_QY_FEE_Click"  style="display:none;" />
</div>
    </form>
</body>
</html>
