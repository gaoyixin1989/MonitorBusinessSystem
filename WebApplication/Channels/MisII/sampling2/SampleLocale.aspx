<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_MisII_sampling2_SampleLocale" Codebehind="SampleLocale.aspx.cs" %>
...
<body>
    ...
    <input id="PlanID" runat="server" type="hidden" />
    <div id="layout4"  style="width: 99%;overflow:hidden; border:1px solid #A3C0E8; ">
    <div position="center" title="监测项目信息">
    <div >
        <asp:LinkButton ID="LinkButton1" Text="查看时限要求" runat="server" OnClientClick="javascript:return viewTimeMgm();"></asp:LinkButton>
        </div>
        <div id="oneFrom">
            </div>
