<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True"
    Inherits="Channels_MisII_sampling2_SamplingAllocationSheet" CodeBehind="SamplingAllocationSheet.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#layout1").ligerLayout({ topHeight: 2 * $(window).height() / 5, leftWidth: '15%', rightWidth: '85%', allowLeftCollapse: false, height: '100%' });
        });
    </script>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    ...
    <div id="targerdiv" class="l-form" style="display: none;">
        <div style="float: left;" class="l-group l-group-hasicon">
            <img src="../../../Controls/ligerui/lib/ligerUI/skins/icons/communication.gif" /><span>质控项目设置
                -
                <asp:Label ID="PointName" runat="server"></asp:Label></span>
        </div>
        <ul>
            <li>
                <table class="tblMain">
                    ...
                    <tr>
                        <td valign="top" width="60%">
                            <b style="text-align: center">密码平行</b> 质控数量：<asp:DropDownList ID="listQc4Count" runat="server">
