<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_MisII_EnvPlan_EnvPlanCheck" Codebehind="EnvPlanCheck.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="EnvPlanCheck.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="layout1">
        <div position="left" title="环境质量数据列表">
