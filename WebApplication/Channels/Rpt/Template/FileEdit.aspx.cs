...
namespace n20
{
    ...
    public partial class Channels_Rpt_Template_FileEdit : System.Web.UI.Page
    {
        ...
        private void SetWebOffice()
        {
            try
            {
                ...
                mIfSign = Request.QueryString["ifSign"];
            }
            catch { }
            //环节信息
            if (mReportWf == null)
            ...
            //是否签名，如清远需要签名ifSign=1，郑州不需要签名不需要设置该值
            if (string.IsNullOrEmpty(mIfSign))
            {
                mIfSign = "0";
            }
        }
