<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Env_Fill_OffShore_OffShoreFill" Codebehind="OffShoreFill.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="OffShoreFill.js" type="text/javascript"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    ...
    <div id="samplingDayDiv" style="display: none">
        <form id="samplingDayForm" method="post">
        </form>
    </div>
    <%--采样日期表单结束--%>
    <%--隐藏元素开始--%>
