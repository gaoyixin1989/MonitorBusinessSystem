<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Env_Fill_Estuaries_EstuariesFill" Codebehind="EstuariesFill.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="EstuariesFill.js" type="text/javascript"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    ...
    <div id="samplingDayDiv" style="display: none">
        <form id="samplingDayForm" method="post" runat ="server">
