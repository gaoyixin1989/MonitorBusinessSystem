...
/// 创建人：魏林
/// 创建日期：2013-06-22
public partial class Channels_Env_Fill_Lake_LakeFill : PageBase
{
    ...
    private void GetFillID()
    {
        ...
        TEnvFillLakeVo envFillLakeVo = new TEnvFillLakeVo();
        envFillLakeVo.YEAR = year;
        envFillLakeVo.MONTH = month;

        envFillLakeVo = new TEnvFillLakeLogic().Details(envFillLakeVo);

        string json = "{\"ID\":\"" + envFillLakeVo.ID + "\",\"STATUS\":\"" + envFillLakeVo.STATUS + "\"}";
    ...
    private void GetData()
    {
        ...
        dtShow = new TEnvFillLakeLogic().CreateShowDT(); 
    ...
    private void ModifyJUDGE()
    {
        ...
        bool result = com.ModifyJUDGE(strFillIDs, TEnvFillLakeVo.T_ENV_FILL_LAKE_TABLE, TEnvFillLakeItemVo.T_ENV_FILL_LAKE_ITEM_TABLE, TEnvPLakeVo.T_ENV_P_LAKE_TABLE, TEnvFillLakeVo.SECTION_ID_FIELD);
