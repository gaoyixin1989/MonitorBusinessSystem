...
/// 创建人：魏林
/// 创建日期：2013-06-27
public partial class Channels_Env_Fill_NoiseArea_AreaNoiseFill : PageBase
{
    ...
    private void GetFillID()
    {
        ...
        TEnvFillNoiseAreaSummaryVo envFillNoiseAreaSummaryVo = new TEnvFillNoiseAreaSummaryVo();
        envFillNoiseAreaSummaryVo.YEAR = year;
        //envFillNoiseAreaSummaryVo.MONTH = month;

        envFillNoiseAreaSummaryVo = new TEnvFillNoiseAreaSummaryLogic().Details(envFillNoiseAreaSummaryVo);

        string json = "{\"ID\":\"" + envFillNoiseAreaSummaryVo.ID + "\",\"STATUS\":\"" + envFillNoiseAreaSummaryVo.STATUS + "\"}";
