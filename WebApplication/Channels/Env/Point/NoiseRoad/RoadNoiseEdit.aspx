<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_NoiseRoad_RoadNoiseEdit" Codebehind="RoadNoiseEdit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#divEdit").ligerForm({
                ...
                { display: "路段名称", name: "ROAD_NAME", newline: true, type: "text" },
                ...
                { display: "道路长度", name: "ROAD_LENGTH", newline: true, type: "text" },
                { display: "道路宽度", name: "ROAD_WIDTH", newline: false, type: "text" },
            ...
            $("#ROAD_LENGTH").attr("validate", "[{maxlength:32,msg:'道路长度录入最大长度为32'}]");
            $("#ROAD_WIDTH").attr("validate", "[{maxlength:32,msg:'道路宽度录入最大长度为32'}]");
