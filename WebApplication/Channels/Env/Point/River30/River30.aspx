<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Env_Point_River30_River30" Codebehind="River30.aspx.cs" %>
...
<asp:Content ID="head" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script src="../../../../Controls/ligerui/lib/ligerUI/js/plugins/ligerLayout.js"
        type="text/javascript"></script>
    <script src="River30.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            GlobalMonitorType = "EnvDWWater";
