//Create by 熊卫华 2012.11.13 
// Modify by weilin 2013.06.07  "饮用地源地点位管理"功能
...
var strTableName = "T_ENV_P_DRINK_SRC_V_ITEM";
var strColumnName = "ITEM_ID";
var strWhereColumnName = "POINT_ID";

var strOneGridTitle = "饮用水源地断面信息";

var strOneGridAddName = "饮用水源地断面信息增加";
var strOneGridUpdateName = "饮用水源地断面信息编辑";

var strUrl = "DrinkingSource.aspx";
var strOneGridUpdateUrl = "DrinkingSourceEdit.aspx";

var intOneGridWidth = 700;
var intOneGridHeight = 500;


var strTwoGridTitle = "";
var strTwoGridAddName = "垂线信息增加";
var strTwoGridUpdateName = "垂线信息编辑";
var strTwoGridUpdateUrl = "DrinkingSourceVeEdit.aspx";
...
$(document).ready(function () {
    ...
    objOneGrid = $("#oneGrid").ligerGrid({
        ...
        height: gridHeight,
        url: strUrl + '?type=getOneGridInfo' + '&flag='+flag,
        columns: [
    ...
    function createData() {
        ...
        }], url: strOneGridUpdateUrl+'?flag='+flag
        });
    }
    //修改数据
    function updateData() {
        ...
        '关闭', onclick: function (item, dialog) { dialog.close(); }
        }], url: strOneGridUpdateUrl + '?id=' + objOneGrid.getSelectedRow().ID+'&flag='+flag
        });
    }
    //删除数据
    function deleteData() {
        ...
        $.ligerDialog.confirm("确认删除断面信息吗？", function (yes) {
            if (yes == true) {
        ...
        '确定', onclick: function (item, dialog) {
            ...
            if (v) {
                ...
                $.ajax({
                    ...
                    data: "{'strTable':'T_ENV_P_DRINK_SRC','strYear':'" + Year_To + "', 'strMonth':'" + Month_To + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data, textStatus) {
                        if (data.d == "1") {
                            ...
                            function (yes) {
                                if (yes == true) {
                                    var rText = $("iframe")[0].contentWindow.DataCopy("type=copyDrinkSrc&Year_From=" + Year_From + "&Month_From=" + Month_From + "&Year_To=" + Year_To + "&Month_To=" + Month_To);
                                    var d = eval(rText);
                                    if (d.result) {
                                        dialog.close();
...
$(document).ready(function () {
    ...
    function PasteItem() {
        ...
        $.ajax({
            ...
            async: true,
            type: "POST",
            url: "../PointInfoCopy.aspx?type=copyDrinkSrcV&fromID=" + $("#VerticalID").val() + "&toID=" + strTwoGridId,
            //data: "{}",
            contentType: "application/json; charset=utf-8",
            dataType: "text",
            success: function (data, textStatus) {
