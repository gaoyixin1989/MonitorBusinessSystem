<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_Payfor_PayforEdit" Codebehind="PayforEdit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#divEdit").ligerForm({
                ...
                { display: "上游断面", name: "UP_POINT", newline: true, type: "text" },
                { display: "断面所在地区", name: "AREA_ID_NAME", newline: false, type: "select", comboboxName: "AREA_ID_NAME", options: { valueFieldID: "AREA_ID", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=administrative_area"} },
                ...
                { display: "控制级别", name: "CONTRAL_LEVEL_NAME", newline: false, type: "select", comboboxName: "CONTRAL_LEVEL_NAME", options: { valueFieldID: "CONTRAL_LEVEL", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=ENV_PAYFOR"} },
            ...
            $("#POINT_CODE").attr("validate", "[{required:true,msg:'请填写断面代码'},{maxlength:32,msg:'断面代码录入最大长度为32'}]");
            $("#POINT_NAME").attr("validate", "[{required:true,msg:'请填写断面名称'},{maxlength:128,msg:'断面名称录入最大长度为128'}]");
            $("#CONTRAL_LEVEL").attr("validate", "[{required:true,msg:'请选择控制级别'}]");
