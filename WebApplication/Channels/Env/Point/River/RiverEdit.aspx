<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_River_RiverEdit" Codebehind="RiverEdit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#divEdit").ligerForm({
                ...
                { display: "类型", name: "REMARK4", newline: false, type: "select", comboxName: "River_Type", options: { valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=ENV_RIVER"} },
