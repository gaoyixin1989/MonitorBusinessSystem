<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_Rain_RainEdit" Codebehind="RainEdit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#divEdit").ligerForm({
                ...
                { display: "具体位置", name: "LOCATION", newline: true, type: "text", width: 50, align: "left", width: 530 }
                ]
            });
