<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_MetalList_MetalListEdit" Codebehind="MetalListEdit.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var url = "MetalListEdit.aspx";
        $(document).ready(function () {
            GlobalMonitorType = " EnvSediment";
            //创建表单结构 
            $("#divEdit").ligerForm({
                ...
                { display: "河流名称", name: "POINT_CODE", newline: true, type: "text" },
                ...
                { display: "监测月度", name: "SELECT_MONTH", newline: true, type: "select", comboboxName: "SELECT_MONTH_BOX", width: 530, options: { valueFieldID: "MONTH", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=itemmonths", isShowCheckBox: true, isMultiSelect: true, selectBoxHeight: 265} },
                ...
                { display: "监测时段", name: "MONITOR_TIMES_ID_NAME", newline: false, type: "select", comboboxName: "MONITOR_TIMES_ID_NAME", options: { valueFieldID: "MONITOR_TIMES_ID", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=monitor_times"} },
