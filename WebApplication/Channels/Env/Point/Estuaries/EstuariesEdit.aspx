<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_Estuaries_EstuariesEdit" Codebehind="EstuariesEdit.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var url = "EstuariesEdit.aspx";
        $(document).ready(function () {
            //创建表单结构 
            $("#divEdit").ligerForm({
                inputWidth: 160, labelWidth: 120, space: 90, labelAlign: 'right',
                fields: [ 
                { display: "年度", name: "YEAR_NAME", newline: false, type: "select", comboboxName: "YEAR_NAME_BOX", options: { valueFieldID: "YEAR", valueField: "value", textField: "value", url: url + "?type=getYearInfo" }, group: "基本信息", groupicon: groupicon },
                ...
                { display: "测站名称", name: "STATION_ID_NAME", newline: false, type: "select", comboboxName: "STATION_ID_NAME", options: { valueFieldID: "STATION_ID", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=SATAIONS"} },
                { display: "断面代码", name: "SECTION_CODE", newline: false, type: "text" },
                { display: "断面名称", name: "SECTION_NAME", newline: false, type: "text" }, 
                { display: "断面所在地区", name: "AREA_ID_NAME", newline: false, type: "select", comboboxName: "SECTION_AREA_NAME", options: { valueFieldID: "AREA_ID", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=administrative_area"} },
            ...
            if ($("#formId").val() != "") {
                $.ajax({
                    ...
                    success: function (data, textStatus) {
                        ...
                        $("#hidValues").val(data.SECTION_CODE);
                    }
                });
            }
            //评价标准选择
