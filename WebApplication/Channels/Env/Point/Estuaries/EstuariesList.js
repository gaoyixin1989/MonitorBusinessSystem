// Create by 熊卫华 2012.11.19  "入海河口监测点管理"功能  Modify by 刘静楠 
...
var strTableName = "T_ENV_P_ESTUARIES_V_ITEM"; 
var strColumnName = "ITEM_ID";
var strWhereColumnName = "POINT_ID";

var strOneGridTitle = "入海河口断面信息";

var strOneGridAddName = "入海河口断面信息增加";
var strOneGridUpdateName = "入海河口断面信息编辑";

var strUrl = "EstuariesList.aspx";
var strOneGridUpdateUrl = "EstuariesEdit.aspx";
...
var strTwoGridUpdateUrl = "EstuariesVerticalEdit.aspx";
...
$(document).ready(function () {
        ...
        '确定', onclick: function (item, dialog) {
            ...
            if (v) {
                ...
                $.ajax({
                    ...
                    data: "{'strTable':'T_ENV_P_ESTUARIES','strYear':'" + Year_To + "', 'strMonth':'" + Month_To + "'}",
                    ...
                    success: function (data, textStatus) {
                        if (data.d == "1") {
                            ...
                            function (yes) {
                                if (yes == true) {
                                    var rText = $("iframe")[0].contentWindow.DataCopy("type=copyEstuariesList&Year_From=" + Year_From + "&Month_From=" + Month_From + "&Year_To=" + Year_To + "&Month_To=" + Month_To);
                                    var d = eval(rText);
                                    if (d.result) {
                                        dialog.close();
    ...
    function showDetailSrh() {
        if (detailWinSrh) {
            ...
            detailWinSrh = $.ligerDialog.open({
                target: $("#Seachdetail"),
                top: 90, width: 350, height: 200, title: strOneGridTitle + "查询",
                buttons: [
    ...
    function search() {
        ...
        objOneGrid.set('url', "" + strUrl + "?type=getOneGridInfo&srhYear= " + SEA_YEAR + "&srhName=" + SEA_NAME + "&srhArea=" + SEA_AREA);
    }
...
function PasteItem() {
    ...
    $.ajax({
        ...
        async: true,
        type: "POST",
        url: "../PointInfoCopy.aspx?type=copyEstuariesVertEdit&fromID=" + $("#VerticalID").val() + "&toID=" + strTwoGridId,
        //data: "{}",
        contentType: "application/json; charset=utf-8",
        dataType: "text",
        success: function (data, textStatus) {
