// Create by 魏林 2013.06.17  "功能区噪声监测点管理"功能
...
var strTableName = "T_ENV_P_NOISE_FUNCTION_ITEM";
var strColumnName = "ITEM_ID";
var strWhereColumnName = "POINT_ID";

var strOneGridTitle = "功能区噪声监测点信息";

var strOneGridAddName = "功能区噪声监测点信息增加";
var strOneGridUpdateName = "功能区噪声监测点信息编辑";

var strUrl = "FunctionNoise.aspx";
var strOneGridUpdateUrl = "FunctionNoiseEdit.aspx";
...
$(document).ready(function () {
    ...
    objOneGrid = $("#oneGrid").ligerGrid({
        ...
        columns: [
                ...
                //{ display: '行政区', name: 'REMARK1', minWidth: 140 },
        ...
        '确定', onclick: function (item, dialog) {
            ...
            if (v) {
                ...
                $.ajax({
                    ...
                    data: "{'strTable':'T_ENV_P_NOISE_FUNCTION','strYear':'" + Year_To + "', 'strMonth':'" + Month_To + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data, textStatus) {
                        if (data.d == "1") {
                            ...
                            function (yes) {
                                if (yes == true) {
                                    var rText = $("iframe")[0].contentWindow.DataCopy("type=copyFunctionNoise&Year_From=" + Year_From + "&Month_From=" + Month_From + "&Year_To=" + Year_To + "&Month_To=" + Month_To);
                                    var d = eval(rText);
                                    if (d.result) {
                                        dialog.close();
        ...
        if (detailWinSrh) {
            ...
            divmainform.ligerForm({
                ...
                fields: [
                        ...
                        { display: "功能", name: "FUN_NAME", newline: true, type: "select", comboboxName: "FUN_NAME_BOX", options: { valueFieldID: "FUN_NAME_OP", valueField: "DICT_CODE", textField: "DICT_TEXT", url: strOneGridUpdateUrl + "?type=getDict&dictType=Function_Area"} }
                        ]
            });
    ...
    function search() {
        ...
        objOneGrid.set('url', "" + strUrl + "?type=getOneGridInfo&srhYear= " + SEA_YEAR + "&srhMonth= " + SEA_MONTH + "&srhName=" + SEA_NAME + "&srhFun=" + SEA_FUN);
...
$(document).ready(function () {
    ...
    function PasteItem() {
        ...
        $.ajax({
            ...
            async: true,
            type: "POST",
            url: "../PointInfoCopy.aspx?type=copyFunctionNoiseV&fromID=" + $("#VerticalID").val() + "&toID=" + strOneGridId,
            //data: "{}",
            contentType: "application/json; charset=utf-8",
            dataType: "text",
            success: function (data, textStatus) {
