<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Env_Point_RiverTarget_RiverTarget" Codebehind="RiverTarget.aspx.cs" %>
...
<asp:Content ID="head" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script src="../../../../Controls/ligerui/lib/ligerUI/js/plugins/ligerLayout.js"
        type="text/javascript"></script>
    <script src="RiverTarget.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            GlobalMonitorType = "EnvRiverTarget";
