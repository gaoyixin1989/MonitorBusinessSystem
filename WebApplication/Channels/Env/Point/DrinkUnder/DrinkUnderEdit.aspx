<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_DrinkUnder_DrinkUnderEdit" Codebehind="DrinkUnderEdit.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var url = "DrinkUnderEdit.aspx";
        $(document).ready(function () {
            GlobalMonitorType = "EnvDrinking";
            //创建表单结构 
            $("#divEdit").ligerForm({
                ...
                { display: "点位代码", name: "POINT_CODE", newline: true, type: "text" },
                { display: "点位名称", name: "POINT_NAME", newline: false, type: "text" },
