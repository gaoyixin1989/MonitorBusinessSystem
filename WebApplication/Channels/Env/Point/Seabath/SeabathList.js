// Create by ljn 2013.06.18  "海水浴场监测点管理"功能 Modify by 刘静楠 
var objOneGrid = null;
var objTwoGrid = null;
...
var strTableName = "T_ENV_P_SEABATH_ITEM";//海水浴场监测项目
var strColumnName = "ITEM_ID";
var strWhereColumnName = "POINT_ID";

var strOneGridTitle = "海水浴场监测点信息";

var strOneGridAddName = "海水浴场监测点信息增加";
var strOneGridUpdateName = "海水浴场监测点信息编辑";

var strUrl = "SeabathList.aspx";
var strOneGridUpdateUrl = "SeabathEditer.aspx";
...
$(document).ready(function () {
    ...
    objOneGrid = $("#oneGrid").ligerGrid({
        ...
        columns: [
                ...
                { display: '监测点代码', name: 'POINT_CODE', minWidth: 120 },
                { display: '监测点名称', name: 'POINT_NAME', minWidht: 120 },
        ...
        '确定', onclick: function (item, dialog) {
            ...
            if (v) {
                ...
                $.ajax({
                    ...
                    data: "{'strTable':'T_ENV_P_SEABATH','strYear':'" + Year_To + "', 'strMonth':'" + Month_To + "'}",
                    ...
                    success: function (data, textStatus) {
                        if (data.d == "1") {
                            ...
                            function (yes) {
                                if (yes == true) {
                                    var rText = $("iframe")[0].contentWindow.DataCopy("type=copySeabathList&Year_From=" + Year_From + "&Month_From=" + Month_From + "&Year_To=" + Year_To + "&Month_To=" + Month_To);
                                    var d = eval(rText);
                                    if (d.result) {
                                        dialog.close();
...
$(document).ready(function () {
    ...
    function ItemSetting() {
        ...
        strItemListTitleName = encodeURIComponent(objOneGrid.getSelectedRow().POINT_NAME);//监测点名称 
    ...
    function PasteItem() {
        ...
        $.ajax({
            ...
            async: true,
            type: "POST",
            url: "../PointInfoCopy.aspx?type=CopySeabathEditer&fromID=" + $("#VerticalID").val() + "&toID=" + strOneGridId,
            contentType: "application/json; charset=utf-8",
            dataType: "text",
            success: function (data, textStatus) {
                var d = eval(data);
