<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_Seabath_SeabathEditer" Codebehind="SeabathEditer.aspx.cs" %>
           ...
           $(document).ready(function () {
               ...
               $("#divEdit").ligerForm({
                   ...
                   fields: [
                                ...
                                { display: '监测点名称', name: 'POINT_NAME', minWidth: 140, newline: true },
                                { display: '监测点编码', name: 'POINT_CODE', minWidth: 140, newline: false },
                                { display: "重点海域代码", name: "KEY_SEA_ID", newline: true, minWidth: 140 },
                                { display: "功能区代码", name: "FUNCTION_CODE", newline: false, minWidth: 140 },
                                ...
                                { display: '海区代码', name: 'SEA_AREA_ID', minWidth: 140, newline: false },
