<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Env_Point_Lake_LakeEdit" Codebehind="LakeEdit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#divEdit").ligerForm({
                ...
                { display: "水库", name: "LAKE_ID_NAME", newline: false, type: "select", comboboxName: "LAKE_ID_NAME", options: { valueFieldID: "LAKE_ID", valueField: "DICT_CODE", textField: "DICT_TEXT", url: url + "?type=getDict&dictType=Lake"} }, 
