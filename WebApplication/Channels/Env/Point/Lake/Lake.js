//Create By 魏林 2013.06.13  湖库监测点管理
...
var strTableName = "T_ENV_P_LAKE_V_ITEM";
var strColumnName = "ITEM_ID";
var strWhereColumnName = "POINT_ID";

var strOneGridTitle = "湖库断面信息";

var strOneGridAddName = "湖库断面信息增加";
var strOneGridUpdateName = "湖库断面信息编辑";

var strUrl = "Lake.aspx";
var strOneGridUpdateUrl = "LakeEdit.aspx";
...
var strTwoGridUpdateUrl = "LakeVerticalEdit.aspx";
        ...
        '确定', onclick: function (item, dialog) {
            ...
            if (v) {
                ...
                $.ajax({
                    ...
                    data: "{'strTable':'T_ENV_P_LAKE','strYear':'" + Year_To + "', 'strMonth':'" + Month_To + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data, textStatus) {
                        if (data.d == "1") {
                            ...
                            function (yes) {
                                if (yes == true) {
                                    var rText = $("iframe")[0].contentWindow.DataCopy("type=copyLake&Year_From=" + Year_From + "&Month_From=" + Month_From + "&Year_To=" + Year_To + "&Month_To=" + Month_To);
                                    var d = eval(rText);
                                    if (d.result) {
                                        dialog.close();
...
$(document).ready(function () {
    ...
    function PasteItem() {
        ...
        $.ajax({
            ...
            async: true,
            type: "POST",
            url: "../PointInfoCopy.aspx?type=copyLakeV&fromID=" + $("#VerticalID").val() + "&toID=" + strTwoGridId,
            //data: "{}",
            contentType: "application/json; charset=utf-8",
            dataType: "text",
            success: function (data, textStatus) {
