...
public partial class Channels_Env_ZZ_Fill_SurfaceDrinkSource_SurfaceDrinkSourceFill : PageBase
{
    ...
    private void GetPoint()
    {
        ...
        DataTable dt = new TEnvPDrinkSrcLogic().PointByTable_Sur(year, month);
        //加入全部
    ...
    private void GetData()
    {
        ...
        //                               "1");
        DataTable dt = new TEnvPDrinkSrcLogic().GetFillData(strWhere,
                                       dtShow,
                                       TEnvPDrinkSrcVo.T_ENV_P_DRINK_SRC_TABLE,
                                       TEnvPDrinkSrcVVo.T_ENV_P_DRINK_SRC_V_TABLE,
                                       TEnvPDrinkSrcVItemVo.T_ENV_P_DRINK_SRC_V_ITEM_TABLE,
