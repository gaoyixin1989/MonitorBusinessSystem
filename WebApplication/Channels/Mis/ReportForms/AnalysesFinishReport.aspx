<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="Channels_Mis_ReportForms_AnalysesFinishReport" Codebehind="AnalysesFinishReport.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="AnalysesFinishReport.js" type="text/javascript"></script>
    <title></title>
    <style type="text/css">
        #menu1, .l-menu-shadow
        {
    ...
    <div id="navtab1" style="width: 98%; overflow: hidden; border: 1px solid #A3C0E8;">
        <div tabid="home" title="正常任务" lselected="true" style="height: 90%">
            <rsweb:ReportViewer ID="reportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                ...
                <LocalReport ReportPath="Channels\Mis\ReportForms\ReportTemple\AnalysesFinishData.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </div>
        <div title="超时任务">
