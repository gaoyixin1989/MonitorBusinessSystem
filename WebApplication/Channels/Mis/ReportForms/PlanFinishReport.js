...
$(document).ready(function () {
    ...
    function showDetailSrh() {
        ...
        function search() {
            ...
            self.location.href="PlanFinishReport.aspx?action=GetTaskListData&strYear=" + SEA_YEAR + "&strContractCode=" + SEA_CONTRACT_CODE + "&strMonth=" + SEA_MONTH + "&strQuarter=" + SEA_QUARTER + "&strArea=" + SEA_AREA + "&strDept=" + SEA_DEPT + "&strTestCompany=" + SEA_TEST_COMPANYNAME;
