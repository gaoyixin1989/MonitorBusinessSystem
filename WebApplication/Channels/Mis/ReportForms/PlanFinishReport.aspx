<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_ReportForms_PlanFinishReport" Codebehind="PlanFinishReport.aspx.cs" %>
...
<head runat="server">
    ...
    <script src="PlanFinishReport.js" type="text/javascript"></script>
    <title></title>
            <style type="text/css">
...
<div tabid="home" title="已完成任务"  lselected="true"  style="height:90%" >
    <rsweb:ReportViewer ID="reportViewer1" runat="server" Font-Names="Verdana" 
        Font-Size="8pt" InteractiveDeviceInfos="(集合)" WaitMessageFont-Names="Verdana" 
        WaitMessageFont-Size="14pt" BackColor="#EAF2FE" ShowFindControls="False"  >
        <LocalReport ReportPath="Channels\Mis\ReportForms\ReportTemple\PlanFinishData.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</div>
<div  title="未完成任务" >
