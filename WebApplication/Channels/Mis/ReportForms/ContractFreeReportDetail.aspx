<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_ReportForms_ContractFreeReportDetail" Codebehind="ContractFreeReportDetail.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="ContractFreeReportDetail.js" type="text/javascript"></script>
    <title></title>
            <style type="text/css">
...
<div >
    <rsweb:ReportViewer ID="reportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Channels\Mis\ReportForms\ReportTemple\ContractFreeDataDetail.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</div>
</div>
