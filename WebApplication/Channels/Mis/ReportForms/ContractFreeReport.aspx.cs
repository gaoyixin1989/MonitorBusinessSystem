...
public partial class Channels_Mis_ReportForms_ContractFreeReport : System.Web.UI.Page
{
    ...
    public void FillChart()
    {
        ...
        objItems.TESTED_COMPANY_ID = strCompanyName;
        TMisContractFeeVo objItemsFree = new TMisContractFeeVo();
        dt = new TMisContractFeeLogic().SelectTableForContractFreeCount(objItems, objItemsFree);
        if (dt.Rows.Count == 0)
        {
    ...
    public void GetAnalyseFinishing()
    {
        ...
        //{
        //    string strAskIng_date = dt.Rows[i]["ASKing_date"].ToString().Trim();
        //    strAskIng_date = strAskIng_date.Replace("/", "-").Replace("0:00:00", "");
        //    dt.Rows[i]["ASKing_date"] = strAskIng_date;
        //}
        //dt.AcceptChanges();
