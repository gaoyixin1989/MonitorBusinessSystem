<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_ReportForms_ContractFreeReport" Codebehind="ContractFreeReport.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="ContractFreeReport.js" type="text/javascript"></script>
    <title></title>
            <style type="text/css">
...
<div tabid="home" title="已缴费"  lselected="true"  style="height:90%" >
    <rsweb:ReportViewer ID="reportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Channels\Mis\ReportForms\ReportTemple\ContractFreeData.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</div>
<div  title="未缴费" >
