<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_ReportForms_ContractFreeReport_Sum" Codebehind="ContractFreeReport_Sum.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="ContractFreeReport_Sum.js" type="text/javascript"></script>
    <title></title>
            <style type="text/css">
...
<div tabid="home" title="已缴费"  lselected="true"  style="height:90%" >
    <rsweb:ReportViewer ID="reportViewer1" runat="server" Font-Names="Verdana" 
        Font-Size="8pt" InteractiveDeviceInfos="(集合)" WaitMessageFont-Names="Verdana" 
        WaitMessageFont-Size="14pt" BackColor="#EAF2FE" ShowFindControls="False"  >
        <LocalReport ReportPath="Channels\Mis\ReportForms\ReportTemple\ContractFreeData_Sum.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</div>
<div  title="未缴费" >
