    ...
    function showDetailSrh() {
        if (detailWinSrh) {
            ...
            detailWinSrh = $.ligerDialog.open({
                target: $("#detailSrh"),
                width: 600, height: 240, top: 90, title: "缴费合同数量统计查询",
                buttons: [
        ...
        function search() {
            ...
            self.location.href = "ContractFreeReport.aspx?action=GetTaskListData&strYear=" + SEA_YEAR + "&strContractCode=" + SEA_CONTRACT_CODE + "&strMonth=" + SEA_MONTH + "&strQuarter=" + SEA_QUARTER + "&strCompanyName=" + SEA_COMPANYNAME + "&strContractType=" + SEA_CONTRACT_TYPE;
