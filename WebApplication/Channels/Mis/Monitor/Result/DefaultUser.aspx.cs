...
/// 创建人  ：熊卫华
/// </summary>
public partial class Channels_Mis_Monitor_Result_DefaultUser : PageBase
{
    ...
    public string SaveUserInfo()
    {
        ...
        {
            isSuccess = new TMisMonitorResultLogic().SaveItemExInfo(Request["strResultId"], Request["DEFAULT_USER"], "HEAD_USERID");
        }
        else
        {
            isSuccess = new TMisMonitorResultLogic().SaveItemExInfo_QHD(Request["strSampleIDs"].ToString().TrimEnd(',').Replace(",","','"), Request["strItemID"], Request["DEFAULT_USER"], "HEAD_USERID");
        }
