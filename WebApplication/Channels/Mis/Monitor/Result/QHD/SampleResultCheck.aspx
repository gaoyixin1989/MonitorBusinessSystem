<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_Result_QHD_SampleResultCheck" Codebehind="SampleResultCheck.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="SampleResultCheck.js" type="text/javascript"></script>
    <script type="text/javascript">
        var topHeight, twoHeight, threeHeight, fourHeight;

        $(function () {
            topHeight = 2 * $(window).height() / 5 - 15;
            twoHeight = 3 * $(window).height() / 5 - 35;
            threeHeight = 3 * $(window).height() / 10 - 35;
            fourHeight = 3 * $(window).height() / 10 - 35;

            $("#layout1").ligerLayout({ topHeight: topHeight+40, leftWidth: 480, allowLeftCollapse: false, height: '100%' });
