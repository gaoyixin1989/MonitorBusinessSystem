<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_Result_QHD_AnalysisResultEnvList" Codebehind="AnalysisResultEnvList.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="AnalysisResultEnvList.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {

            $("#layout1").ligerLayout({ topHeight: 270, leftWidth: 420, allowLeftCollapse: false, height: 760 });
...
<body  style="padding: 0px; overflow: hidden; width: 99%; height: 100%;">
    ...
    <div id="layout1">
        <div position="top">
            <div id="layout3">
                <div position="left" title="任务信息" id="oneGrid">
                </div>
                <div position="right" title="监测类别" id="MonitorGrid">
                </div>
            </div>
        </div>
