...
/// 创建人  ：熊卫华
/// </summary>
public partial class Channels_Mis_Monitor_Result_ZZ_AnalysisResultCheck : PageBase
{
    ...
    private string getOneGridInfo()
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskCheckInfo_QHD(LogInfo.UserInfo.ID, "duty_other_analyse_result", "03", "0", "30", "", intPageIndex, intPageSize);
        int intTotalCount = new TMisMonitorResultLogic().getTaskInfoCheckCount_QHD(LogInfo.UserInfo.ID, "duty_other_analyse_result", "03", "0", "30", "");
    ...
    {
        DataTable dt = new TMisMonitorResultLogic().geResultChecktItemTypeInfo_QHD(LogInfo.UserInfo.ID, "duty_other_analyse_result", strOneGridId, "03", "0", "30");
    ...
    private string getThreeGridInfo(string strTwoGridId)
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskSimpleCheckInfo_QHD(strTwoGridId, "0", "30", intPageIndex, intPageSize, "", "");
        ...
        int intTotalCount = new TMisMonitorResultLogic().getTaskSimpleCheckInfoCount_QHD(strTwoGridId, "0", "30", "", "");
        string strJson = CreateToJson(dt, intTotalCount);
        return strJson;
    }
    /// <summary>
    ...
    private string getFourGridInfo(string strThreeGridId)
    {
        ...
        //每页记录数
        int intPageSize = Convert.ToInt32(Request.Params["pagesize"]);
        DataTable dt = new TMisMonitorResultLogic().getTaskItemCheckInfo(LogInfo.UserInfo.ID, strThreeGridId, "30", "", "");
        string strJson = CreateToJson(dt, dt.Rows.Count);
        return strJson;
    }
    /// <summary>
    ...
    public string SendToNext(string strTaskId)
    {
        ...
        bool isSuccess = new TMisMonitorResultLogic().SendTaskCheckToNextFlow_QHD(strTaskId, LogInfo.UserInfo.ID, "03", "duty_other_analyse_result", "0", "30", "40", true, "");
    ...
    {
        bool isSuccess = new TMisMonitorResultLogic().SendResultToNext_ZZ(strResultId, LogInfo.UserInfo.ID, "30", "40");
        return isSuccess == true ? "1" : "0";
    }
    /// <summary>
    /// 获取企业名称信息
