<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Masters/SearchEx.master" Inherits="Channels_Mis_Monitor_Result_ZZ_AnalysisResult" Codebehind="AnalysisResult.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#layout1").ligerLayout({ leftWidth: 350, allowLeftCollapse: false, height: '100%' });
        });
    </script>
</asp:Content>
