...
/// 创建人  ：熊卫华
/// </summary>
public partial class Channels_Mis_Monitor_Result_ZZ_AnalysisTaskAllocation : PageBase
{
    ...
    private string getOneGridInfo()
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskInfo(LogInfo.UserInfo.ID, "duty_other_analyse", "03", "01", intPageIndex, intPageSize);
        int intTotalCount = new TMisMonitorResultLogic().getTaskInfoCount(LogInfo.UserInfo.ID, "duty_other_analyse", "03", "01");
    ...
    {
        DataTable dt = new TMisMonitorResultLogic().getItemTypeInfo(LogInfo.UserInfo.ID, "duty_other_analyse", strOneGridId, "03", "01");
    ...
    {
        DataTable dt = new TMisMonitorResultLogic().getSimpleCodeInAlloction_QHD(strTwoGridId, LogInfo.UserInfo.ID, "01", "0", "", "");
        string strJson = CreateToJson(dt, 0);
        return strJson;
    }
    /// <summary>
    ...
    private string getFourGridInfo(string strThreeGridId)
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getItemInfoInAlloction_QHD(strThreeGridId, "01", "0", "", "", intPageIndex, intPageSize);
        int intTotalCount = new TMisMonitorResultLogic().getItemInfoCountInAlloction_QHD(strThreeGridId, "01", "0", "", "");
        string strJson = CreateToJson(dt, intTotalCount);
        return strJson;
    }
    /// <summary>
    ...
    {
        bool IsSuccess = new TMisMonitorResultLogic().subTaskGoToBack(strTaskId, LogInfo.UserInfo.ID, "021", "duty_other_analyse");
    ...
    {
        bool IsSuccess = new TMisMonitorResultLogic().sendToNextFlow(strTaskId, LogInfo.UserInfo.ID, "duty_other_analyse", "03", "01", "20");
        return IsSuccess == true ? "1" : "0";
    }
    /// <summary>
    /// 获取企业名称信息
