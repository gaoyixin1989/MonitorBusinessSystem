<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_Result_ZZ_AnalysisResultCheck" Codebehind="AnalysisResultCheck.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#layout1").ligerLayout({ topHeight: topHeight, leftWidth: 250, allowLeftCollapse: false, height: '100%' });
