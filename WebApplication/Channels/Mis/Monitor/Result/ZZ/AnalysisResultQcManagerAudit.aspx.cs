...
/// 创建人  ：熊卫华
/// </summary>
public partial class Channels_Mis_Monitor_Result_ZZ_AnalysisResultQcManagerAudit : PageBase
{
    ...
    private string getTwoGridInfo(string strOneGridId)
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskSimpleQcCheckInfo_ZZ(strOneGridId, "03", "50", intPageIndex, intPageSize);
        ...
        int intTotalCount = new TMisMonitorResultLogic().getTaskSimpleQcCheckInfoCount_ZZ(strOneGridId, "03", "50");
        string strJson = CreateToJson(dt, intTotalCount);
        return strJson;
    }
    /// <summary>
    ...
    private string getThreeGridInfo(string strTwoGridId)
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskItemQcCheckInfo_ZZ(strTwoGridId, "50");
    ...
    private string GoToBack(string strTaskId, string Rtn_Content)
    {
        ...
        bool IsSuccess = new TMisMonitorResultLogic().TaskGoBackInQcCheck_QHD(strTaskId, LogInfo.UserInfo.ID, "qc_manager_audit", "0", "50", "40");
        return IsSuccess == true ? "1" : "0";
    }
    //判断任务是否可以发送
    public string IsCanSendTaskQcToNextFlow(string strTaskId)
    {
        bool IsCanGoToBack = new TMisMonitorResultLogic().TaskCanSendInQcManagerAudit_ZZ(strTaskId, "50");
        return IsCanGoToBack == true ? "1" : "0";
    }
    private string SendToNext(string strTaskId)
    {
        //记录当前分析环节的发送人
        DataTable objTable = new TMisMonitorResultLogic().geResultChecktItemTypeInfo_QHD(LogInfo.UserInfo.ID, "qc_manager_audit", strTaskId, "03", "0", "50");
        ...
        bool isSuccess = new TMisMonitorResultLogic().SendTaskCheckToNextFlow_ZZ(strTaskId, "03", "50", "60");
        return isSuccess == true ? "1" : "0";
    }
    /// <summary>
    /// 获取企业名称信息
