<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_Result_ZZ_AnalysisResultQcCheck" Codebehind="AnalysisResultQcCheck.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#layout2").ligerLayout({ topHeight: 200, leftWidth: '50%', rightWidth: '50%', allowLeftCollapse: false, allowRightCollapse: false, height: 510 });
        });
    </script>
</head>
