...
/// 创建人  ：黄进军
/// </summary>
public partial class Channels_Mis_Monitor_ZZ_ResultAddLst : PageBase
{
    ...
    protected void getOneGridInfo()
    {
        ...
        DataTable dt = new TMisMonitorTaskLogic().GetCompleteTask(intPageIndex, intPageSize);
        int intTotalCount = new TMisMonitorTaskLogic().GetTaskCount();
    ...
    private string getTwoGridInfo(string strOneGridId)
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskSimpleQcCheckInfo(strOneGridId, LogInfo.UserInfo.ID, "duty_other_analyse_control", "09", "60", intPageIndex, intPageSize);
    ...
    private string getThreeGridInfo(string strTwoGridId)
    {
        ...
        DataTable dt = new TMisMonitorResultLogic().getTaskItemQcCheckInfo(strTwoGridId, "60");
