...
/// 创建人：weilin
/// </summary>
public partial class Channels_Mis_Monitor_Result_QY_SampleResultCheckList : PageBase
{
    ...
    protected string GetReportInfo()
    {
        ...
        dt = new TMisMonitorSubtaskLogic().SelectSamplingCheckList(LogInfo.UserInfo.ID, "022", pageIndex, pageSize, true);

        intTotalCount = new TMisMonitorSubtaskLogic().SelectSamplingCheckListCount(LogInfo.UserInfo.ID, "022", true);
