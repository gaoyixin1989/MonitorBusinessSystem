<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_Result_AnalysisResultQcCheck" Codebehind="AnalysisResultQcCheck.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#layout1").ligerLayout({ topHeight: 250, leftWidth: 200, allowLeftCollapse: false, height: 760 });
