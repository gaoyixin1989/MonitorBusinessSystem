    ...
    $("#divEdit").ligerForm({
        ...
        fields: [
                ...
                //{ display: "监测频次", name: "FREQ", newline: false, type: "select", comboboxName: "FREQ1", options: { valueFieldID: "FREQ", url: "../../../Base/MonitorType/Select.ashx?view=T_SYS_DICT&idfield=DICT_CODE&textfield=DICT_TEXT&where=DICT_TYPE|FREQ"} },
                 {display: "采样频次", name: "SAMPLE_FREQ", newline: false, type: "select", comboboxName: "SAMPLEFREQ_Box", options: { valueFieldID: "SAMPLEFREQ_OP", url: "../../../Base/MonitorType/Select.ashx?view=T_SYS_DICT&idfield=DICT_CODE&textfield=DICT_TEXT&where=DICT_TYPE|POINT_SAMPLEFREQ"} },
