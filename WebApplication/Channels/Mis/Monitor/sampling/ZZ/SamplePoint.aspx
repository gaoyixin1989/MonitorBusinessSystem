<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Masters/Search.master" Inherits="Channels_Mis_Monitor_sampling_ZZ_SamplePoint" Codebehind="SamplePoint.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        $(function () {
            $("#layout3").ligerLayout({ leftWidth: "60%", rightWidth: "39%", height: 500, allowLeftCollapse: false, allowRightCollapse: false });
        });
    </script>
</asp:Content>
