<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_sampling_ZZ_Sampling" Codebehind="Sampling.aspx.cs" %>
...
<body>
    ...
    <div id="layout1" style="width: 99%; overflow: hidden; border: 1px solid #A3C0E8;">
        <div position="center" id="framecenter">
            ...
            <div title="监测点位">
                <iframe frameborder="0" id="SamplePointID" name="showmessage" src='SamplePoint.aspx?strSubtaskID=<%=this.Request["strSubtaskID"].ToString() %>'>
                </iframe>
            </div>
            <div title="现场监测项目">
    ...
    <div style="text-align: center; width: 99%">
        ...
        <input type="button" value="退回" id="btn_back" name="btn_back" class="l-button l-button-submit"
            onclick="BackClick();" style="display: inline; margin-top: 8px;" />
    </div>
