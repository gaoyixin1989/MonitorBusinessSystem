...
/// <summary>
/// 功能描述：采样-现状信息【现场项目退回采样环节使用】
/// 创建日期：2013-05-07
/// 创建人  ：熊卫华
/// </summary>
public partial class Channels_Mis_Monitor_sampling_ZZ_SampleLocaleView : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["strSubtaskID"]) && !string.IsNullOrEmpty(Request.QueryString["IS_SEND"]) && Request.QueryString["IS_SEND"] == "2")
            {
