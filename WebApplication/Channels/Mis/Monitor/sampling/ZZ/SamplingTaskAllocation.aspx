<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="Channels_Mis_Monitor_sampling_ZZ_SamplingTaskAllocation" Codebehind="SamplingTaskAllocation.aspx.cs" %>
...
<body>
    ...
    <div style="text-align: center; width: 100%">
        <input type="button" value="发送" id="btn_Ok" name="btn_Ok" class="l-button l-button-submit"
            style="display: inline-block; margin-top: 8px;" onclick="SendClick();" />
        <input type="button" value="任务通知单" id="btnPrint" name="btnPrint" class="l-button l-button-submit"
