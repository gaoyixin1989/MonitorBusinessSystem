<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_sampling_ZZ_QcTwinSetting" Codebehind="QcTwinSetting.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function QcSave() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: strUrl + "/QcSave",
                data: "{'strSampleID':'" + $("#txtSampleId").val() + "','strQcType':'" + $("#txtQcType").val() + "','strItemId':'" + sum + "','strQcCount':'" + $("#dropQcCount").val() + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
