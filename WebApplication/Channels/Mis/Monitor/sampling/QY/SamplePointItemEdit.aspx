<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_sampling_QY_SamplePointItemEdit" Codebehind="SamplePointItemEdit.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        .l-table-edit-td  .l-text{ width:152px;}
          ...
          <table cellpadding="0" cellspacing="0" class="tabletool" >
             <tr>
                <td  class="l-table-edit-td"  style="width:182px; padding-left:12px;">
                 <span style=" display:inline-block; padding-right:4px; ">检索</span><input id="allItemSrh" ClientIDMode="Static" class="l-text l-text-editing" onkeyup="javascript:allItemSrh_TextChanged();" type="text" /> 
               ...
               <asp:Button ID="btn2" ClientIDMode="Static" runat="server" CssClass="l-button l-button-submit" Text="<<" OnClientClick="return exchange(this,'ListBox1','ListBox2','txtdel');"/>
                ...
                <asp:ListBox ID="ListBox2" ClientIDMode="Static" runat="server" Width="182px" Height="200px" style="border:1px solid #a0e1ff"  SelectionMode="Multiple"></asp:ListBox>
        </td>
            </tr>
</table>
    </div>
