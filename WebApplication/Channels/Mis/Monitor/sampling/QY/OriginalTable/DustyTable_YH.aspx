<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_sampling_QY_OriginalTable_DustyTable_YH" Codebehind="DustyTable_YH.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="DustyTable_YH.js" type="text/javascript"></script>
    <style type="text/css">
        body
        {
            padding: 5px;
