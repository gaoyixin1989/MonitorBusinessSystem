...
public partial class Channels_Mis_Monitor_sampling_QY_SampleResultView : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                //监测子任务ID
                //监测子任务ID 获取主线的监测子任务ID
                this.SUBTASK_ID.Value = new TMisMonitorSubtaskLogic().Details(Request.QueryString["strSubtaskID"].ToString()).REMARK1;
            }
    ...
    protected string GetPointInfo()
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            dt.Rows[i]["REMARK3"] = objSample.ID;
        }
    ...
    /// </summary>
    /// <returns>Json</returns>
    protected string GetItemInfo(string strSAMPLEID)
    {
        ...
        dt = new TMisMonitorResultLogic().SelectSampleDeptResultEx(this.SUBTASK_ID.Value, strSAMPLEID);
