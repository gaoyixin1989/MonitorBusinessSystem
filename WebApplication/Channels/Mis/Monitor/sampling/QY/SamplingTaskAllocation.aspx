<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_sampling_QY_SamplingTaskAllocation" Codebehind="SamplingTaskAllocation.aspx.cs" %>
...
<body>
    ...
    <div style="text-align: center; width: 100%">
        ...
        <%--<asp:Button ID="btnImport" Text="任务单"  runat="server"  class="l-button l-button-submit"  style="display:inline-block; margin-top:8px;"  OnClick="btnImport_Click" />--%>
