...
/// 创建人  ：魏林
/// </summary>
public partial class Channels_Mis_Monitor_sampling_QY_QcEditBlindSetting : PageBase
{
    ...
    {
        DataTable objTable = new TBaseItemInfoLogic().SelectQcBlindItem(this.txtSampleId.Value.Trim(), this.txtQcType.Value.Trim());
    ...
    public static bool QcUpdate(string strID, string strUpdateCell, string strUpdateCellValue)
    {
        ...
        isSuccess = new TBaseItemInfoLogic().UpdateQcInfo("T_MIS_MONITOR_QC_BLIND_ZZ", strUpdateCell, strUpdateCellValue, strID);
