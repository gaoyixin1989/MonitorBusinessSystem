<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True"
    Inherits="Channels_Mis_Monitor_sampling_SamplingAssignmentSheet" Codebehind="SamplingAssignmentSheet.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="SamplingAssignmentSheet.js" type="text/javascript"></script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="strSubTaskId" runat="server" />
