...
function click_OfDblclick(data) {
    ...
    var surl = "../Channels/Mis/Monitor/sampling/Sampling.aspx?strSubtaskID=" + data.ID;
...
function click_OfToolbar(item) {
    switch (item.id) {
        case 'done':
            ...
            var tabid = "tabidSamplingNew"
            var surl = "../Channels/Mis/Monitor/sampling/Sampling.aspx?strSubtaskID=" + selected.ID;
            top.f_addTab(tabid, '采样', surl);
...
function click_OfMenu(item) {
    switch (item.id) {
        case 'menudone':
            ...
            var tabid = "tabidSamplingNew"
            var surl = "../Channels/Mis/Monitor/sampling/Sampling.aspx?strSubtaskID=" + actionID;
            top.f_addTab(tabid, '采样', surl);
