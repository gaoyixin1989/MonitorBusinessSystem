<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Monitor_sampling_QHD_QcEmptySetting" Codebehind="QcEmptySetting.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var strUrl = "QcEmptySetting.aspx";
        ...
        function QcSave() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: strUrl + "/QcSave",
                data: "{'strSampleID':'" + $("#txtSampleId").val() + "','strQcType':'" + $("#txtQcType").val() + "','strItemId':'" + sum + "','iSampleCode':'" + $("#iSampleCode").val() + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<body>
    ...
    <div class="l-form" style="text-align: center">
        <div style="float: left;" class="l-group l-group-hasicon">
            <img src="../../../../../Controls/ligerui/lib/ligerUI/skins/icons/communication.gif" /><span>空白设置
        </div>
        <ul>
            <li>
                <table width="400px">
