...
/// <summary>
/// 功能描述：采样任务分配前站长审核-秦皇岛
/// 创建日期：2013-08-26
/// 创建人  ：胡方扬
/// </summary>
public partial class Channels_Mis_Monitor_sampling_QHD_ManagerAuditSampling : PageBase
{
    ...
    /// <param name="strSampleAskDate">采样时间</param>
    /// <param name="strSampleFinishDate">要求完成时间</param>
    /// <param name="strTicketNum">任务单号</param>
    /// <param name="strQCStatus">质控状态</param>
