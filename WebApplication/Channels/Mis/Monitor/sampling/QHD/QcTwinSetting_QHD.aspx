<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="Channels_Mis_Monitor_sampling_QHD_QcTwinSetting_QHD" Codebehind="QcTwinSetting_QHD.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var strUrl = "QcTwinSetting_QHD.aspx";

        $(document).ready(function () {
            //往列表中加载数据
            GetSampleItemToList($("#txtSubTaskId").val(), "#listAll", "0");
            GetSampleItemToList($("#txtSubTaskId").val(), "#listSelected", $("#txtQcType").val());
        ...
        //将获取的质控数据填充到列表中
        function GetSampleItemToList(strSubTaskId, strControlName, strQcType) {
            $.ajax({
                cache: false,
                async: false,
                type: "POST",
                url: strUrl + "/GetSampleItem",
                data: "{'strSubTaskId':'" + strSubTaskId + "','strQcType':'" + strQcType + "'}",
        ...
        function QcSave() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: strUrl + "/QcSave",
                data: "{'strSubTaskId':'" + $("#txtSubTaskId").val() + "','strQcType':'" + $("#txtQcType").val() + "','strItemId':'" + sum + "','strQcCount':'" + $("#dropQcCount").val() + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<body>
    ...
    <div class="l-form" style="text-align: center">
        <div style="float: left;" class="l-group l-group-hasicon">
            <img src="../../../../../Controls/ligerui/lib/ligerUI/skins/icons/communication.gif" /><span>质控平行设置
        </div>
        <ul>
            <li>
                <table width="400px">
