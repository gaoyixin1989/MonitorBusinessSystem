...
public partial class Channels_Mis_Monitor_sampling_QHD_SampleResult : PageBase
{
    ...
    protected string GetItemInfo(string strPointID)
    {
        ...
        dt = new TMisMonitorResultLogic().SelectSampleDeptResult_QHD(this.SUBTASK_ID.Value, strPointID);
