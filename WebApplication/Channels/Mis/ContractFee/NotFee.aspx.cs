...
/// 创建人  ：潘德军
/// </summary>
public partial class Channels_Mis_ContractFee_NotFee : PageBase
{
    ...
    private void GetFees()
    {
        ...
        objFee.IF_PAY = "0";
        DataTable dt = new TMisContractFeeLogic().SelectByTableCreateByHHL(objFee, intPageIndex, intPageSize);//何海亮修改
        int intTotalCount = new TMisContractFeeLogic().GetSelectResultCountByHHL(objFee);
    ...
    //缴费
    [WebMethod]
    public static string setPay(string strValue,string payMoney,DateTime payDate)
    {
        
        TMisContractFeeVo objFee = new TMisContractFeeVo();
        objFee.ID = strValue;
        objFee.IF_PAY = "1";
        objFee.INCOME = payMoney;
        objFee.REMARK5 = payDate.ToString();
