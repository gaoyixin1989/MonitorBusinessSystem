<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Mis_Report_ReportList" Codebehind="ReportList.aspx.cs" %>
    ...
    <div id="layout1" style="text-align: left">
        <div position="center" title="">
            <div id="navtab1" style="width: 100%; overflow: hidden; border: 1px solid #A3C0E8;">
                <div id="firstgrid" title="未办理任务">
                </div>
                <div id="secondgrid" title="已办理任务">
                </div>
            </div>
        </div>
    </div>
