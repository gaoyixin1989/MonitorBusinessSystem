...
/// 创建人：邵世卓
/// </summary>
public partial class Channels_Mis_Report_ReportApprove : PageBaseForWF, IWFStepRules
{
    protected void Page_Load(object sender, EventArgs e)
    {
        this.ReportStatus.Value = "ReportApprove";//报告环节
        if (!IsPostBack)
        {
    ...
    void IWFStepRules.CreatAndRegisterBusinessData()
    {
        ...
        {
            //更改监测任务状态
            objTask.TASK_STATUS = "10.1";
        }
        else
        {
            //更改监测任务状态
            objTask.TASK_STATUS = "10.3";
            ////保存报告签发人信息
