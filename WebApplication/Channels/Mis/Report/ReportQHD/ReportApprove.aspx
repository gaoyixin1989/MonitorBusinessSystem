<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Report_ReportQHD_ReportApprove" Codebehind="ReportApprove.aspx.cs" %>
            ...
            <ul>
                ...
                <li>
                    <input type="button" value="报告生成" id="btn_Ok" name="btn_Ok" class="l-button l-button-submit"
                        onclick="ReportClick();" /><input type="button" value="验收报告" id="btnAccept" class="l-button l-button-submit"
