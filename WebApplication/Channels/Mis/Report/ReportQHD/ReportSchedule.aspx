<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Report_ReportQHD_ReportSchedule" Codebehind="ReportSchedule.aspx.cs" %>
    ...
    <div id="layout1">
        ...
        <div id="divPointItem">
            ...
            <div position="bottom" style="padding: 12px;">
                <div id="divSample" style="float: left; width: 40%;">
                    <div id="sampleDiv">
                    </div>
                </div>
