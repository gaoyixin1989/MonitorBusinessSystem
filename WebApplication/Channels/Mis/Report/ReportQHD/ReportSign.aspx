<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Report_ReportQHD_ReportSign" Codebehind="ReportSign.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="ReportSign.js" type="text/javascript"></script>
    <title></title>
</head>
<body>
    ...
    <div id="layout1">
        ...
        <div class="l-form">
            ...
            <div style="height: 20px; clear: both; margin-left: 40px;">
                <a onclick="downLoad();" style="cursor: pointer" href="#">报告下载</a>
            </div>
        </div>
        <div class="tableh2">
            <img src="../../../../Controls/ligerui/lib/ligerUI/skins/icons/communication.gif" />
