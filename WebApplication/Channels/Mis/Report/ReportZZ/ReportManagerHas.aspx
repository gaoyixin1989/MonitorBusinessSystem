<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" Inherits="Channels_Mis_Report_ReportZZ_ReportManagerHas" Codebehind="ReportManagerHas.aspx.cs" AutoEventWireup="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    <div id="layoutHasGetRpt" style="text-align:left">
        <div position="center"  title="">
            <div id="gridHasGetRpt"></div>
        </div>
    </div>
