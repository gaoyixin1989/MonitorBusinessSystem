<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Report_ReportZZ_ReportQcCheck" Codebehind="ReportQcCheck.aspx.cs" %>
        ...
        <div tabid="home" title="报告生成" lselected="true" style="height: 100%">
            ...
            <div class="l-form">
                ...
                <ul>
                    ...
                    <li>
                        <input type="button" value="报告生成" id="btn_Ok" name="btn_Ok" class="l-button l-button-submit"  onclick="ReportClick();" />
                        <input type="button" value="验收报告" id="btnAccept" class="l-button l-button-submit"   style="display: none" onclick="downLoad();" /></li>
                </ul>
            </div>
            <div class="tableh2">
                <img src="../../../../Controls/ligerui/lib/ligerUI/skins/icons/communication.gif" />
