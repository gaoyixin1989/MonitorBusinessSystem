...
/// 创建人：潘德军
/// </summary>
public partial class Channels_Mis_Report_ReportZZ_Report_Done : PageBase
{
    ...
    protected string GetReportInfo()
    {
        ...
        intTotalCount = new TMisMonitorTaskLogic().GetSelectResultCountForZZ(objTask, LogInfo.UserInfo.ID,true);
        dtEval = new TMisMonitorTaskLogic().SelectByTableForZZ(objTask, LogInfo.UserInfo.ID, pageIndex, pageSize, true);
