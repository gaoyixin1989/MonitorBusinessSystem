...
$(document).ready(function () {
    ...
    menuFirst = $.ligerMenu({ width: 120, items:
            [
            { id: 'Do', text: '任务确认', click: itemclick_OfToolbar_UnderItem_First, icon: 'modify' }
            ]
    });
    firstManager = $("#firstgrid").ligerGrid({
        ...
        toolbar: { items: [
                ...
                { line: true },
                { id: 'Do', text: '任务确认', click: itemclick_OfToolbar_UnderItem_First, icon: 'add' }
                ]
        },
    ...
    menuSecond = $.ligerMenu({ width: 120, items:
            [
            { id: 'Do', text: '任务办理', click: itemclick_OfToolbar_UnderItem_Second, icon: 'modify' }
            ]
    });
    secondManager = $("#secondgrid").ligerGrid({
        ...
        toolbar: { items: [
                ...
                { line: true },
                { id: 'Do', text: '任务办理', click: itemclick_OfToolbar_UnderItem_Second, icon: 'add' }
                ]
        },
        onCheckRow: function (checked, rowdata, rowindex) {
            for (var rowid in this.records)
    ...
    function itemclick_OfToolbar_UnderItem_Second(item) {
        switch (item.id) {
            ...
            case 'Do':
                ...
                //ComleteTask(selectId);
                //firstFlowName = $("#cphData_FirstFlowName").val();
