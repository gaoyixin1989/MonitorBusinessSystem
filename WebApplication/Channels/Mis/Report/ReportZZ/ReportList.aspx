<%@ Page Language="C#" MasterPageFile="~/Masters/SearchEx.master" AutoEventWireup="True" Inherits="Channels_Mis_Report_ReportZZ_ReportList" Codebehind="ReportList.aspx.cs" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
    ...
    <script src="ReportList.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="cphData" runat="Server">
    <input type="hidden" id="FirstFlowName" runat="server" />
    <div id="layout1" style="text-align: left">
        <div position="center" title="">
            <div id="navtab1" style="width: 100%; overflow: hidden; border: 1px solid #A3C0E8;">
                <div id="firstgrid" title="未确认任务">
                </div>
                <div id="secondgrid" title="已确认任务">
                </div>
            </div>
        </div>
    </div>
