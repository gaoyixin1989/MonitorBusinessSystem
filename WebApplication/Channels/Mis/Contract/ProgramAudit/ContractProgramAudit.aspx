<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Contract_ProgramAudit_ContractProgramAudit" Codebehind="ContractProgramAudit.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <!--业务JS-->
    <script src="ContractProgramAudit.js" type="text/javascript"></script>
    <script src="ContractProgramAudit_Company.js" type="text/javascript"></script>
    <script src="ContractProgramAudit_Info.js" type="text/javascript"></script>
        <script src="ContractProgramAudit_OtherInfor.js" type="text/javascript"></script>
    <script src="ContractProgramAuditPlan.js" type="text/javascript"></script>
    <script src="ContractProgramAuditPointItems.js" type="text/javascript"></script>
    <script src="ContractProgramAuditSubmit.js" type="text/javascript"></script>
    <title></title>
</head>
<body>
