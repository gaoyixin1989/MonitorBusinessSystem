...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "../MethodHander.ashx?action=GetWebConfigValue&strKey=YSDelValue",
    ...
    function createQueryString() {
        ...
        strParme += "&strProData=" + strProData + "&strOtherAsk=" + strOtherAsk + "&strAccording=" + strAccording + "&strtxtRemarks=" + strtxtRemarks;
        return strParme;
    }
