<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="Channels_Mis_Contract_EnvAcceptance_AcceptanceSchedule" Codebehind="AcceptanceSchedule.aspx.cs" %>
            ...
            <tr>
                <td colspan="100%" style="clear: both; padding-bottom: 7px;">
                    ...
                    <div style="clear: both; margin-left: 40px;">
                        方案附件：<a onclick="upload();" style="cursor: pointer" href="#">上传</a> <a onclick="downLoad();"
                            style="cursor: pointer" href="#">下载</a>
                    </div>
                </td>
            </tr>
        </table>
