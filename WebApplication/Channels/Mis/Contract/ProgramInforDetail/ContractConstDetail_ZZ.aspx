<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Contract_ProgramInforDetail_ContractConstDetail" Codebehind="ContractConstDetail_ZZ.aspx.cs" %>
...
<head runat="server">
    ...
    <script src="ContractConstDetail_ZZ.js" type="text/javascript"></script>
</head>
...
<form id="form1" runat="server">
    <div id="layout1" title="监测费用明细">
        ...
        <tr>
                ...
                <tr>
                        <td align="right" class="l-table-edit-td">上传或下载:</td>
                        <td align="left" class="l-table-edit-td">
                        <div id="divFileExcelUp" style="float:left; margin-right:10px;"></div>
                         <div id="divFileExcelDown" style="float:left"></div>
                        </td>
        </tr>
        </table>
</div>
