<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_Contract_ProgramInforDetail_ContractPointItems" Codebehind="ContractPointItems.aspx.cs" %>
...
<head runat="server">
    ...
    <script src="ContractPointItems.js" type="text/javascript"></script>
    <style type="text/css">
        h1{color:Green;}
 ...
 <table cellpadding="0" cellspacing="0" class="tabletool" >
            ...
            <select size="10" name="listLeft" multiple="multiple" id="listLeft"  class="normal" style="width:160px;"  title="双击可实现右移"> 
                ...
                <td align="left" class="inputdiv"> 
                 行业<input type="text" value="" id="txtIndustry"  />                    
        ...
        <td style="display:none;">
           <select size="10" multiple="multiple" id="listTemp"  class="normal"   style="width:160px;height:260px;"> 
           </select>
        </td>
            </tr>
</table>
