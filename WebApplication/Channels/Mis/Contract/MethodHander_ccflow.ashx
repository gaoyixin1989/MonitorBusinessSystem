...
public class MethodHander : PageBase, IHttpHandler, IRequiresSessionState
{
    ...
    public string ccflowWorkID = "";//by lhm
    ...
    private string UpdateTestFree()
    {
        ...
        {
            objItems.TEST_PURPOSE = strTestAnsyFee;
        }
    ...
    /// </summary>
    /// <returns></returns>
    private string InsertContractInfo()
    {
        string result = "";
        TMisContractVo objtCv = new TMisContractVo();
        objtCv.ID = i3.View.PageBase.GetSerialNumber("t_mis_contrat_Id");
    ...
    private string SaveCheckContractInfor()
    {
        ...
        objTmis.REMARK5 = ccflowWorkID;//by lhm
    ...
    private void GetRequestParme(HttpContext context)
    {
        ...
        if (!String.IsNullOrEmpty(context.Request.Params["ccflowWorkID"]))
        {
            ccflowWorkID = context.Request.Params["ccflowWorkID"].Trim();
        }
    }
