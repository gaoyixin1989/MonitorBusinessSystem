<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_MonitoringPlan_EnvPlanAdd" Codebehind="EnvPlanAdd.aspx.cs" %>
...
<body>
    ...
    <table>
        <tr >
            <th style=" padding-top:5px; padding-left:5px;">环境类别:</th>
            ...
            <th style=" padding-top:5px; padding-left:5px;">月份:</th>
            <td align="left"  class="l-table-edit-td" style=" padding-top:5px" >
                <input type="text" id="EnvMonth" name="EnvMonth"  class="l-text l-text-editing" style="width:160px" />
            </td>
        </tr>
            <%--<tr >
                <th style=" padding-top:5px">断面名称:</th>
            <td align="left"  class="l-table-edit-td" style=" padding-top:5px">
            <input type="text" id="DmName" name="DmName"  class="l-text l-text-editing" style="width:200px"/></td>
            </tr>--%>
        <tr>
            <th style=" padding-top:5px;padding-left:5px;">项目名称:</th>
        ...
        <tr>
            ...
            <td align="left"  class="l-table-edit-td" style=" padding-top:5px">
                <input type="text" id="txtDate" name="txtDate"  class="l-text l-text-editing"  /></td>
            <th style=" padding-top:5px">要求完成日期:</th>
            <td align="left"  class="l-table-edit-td float2013" style=" padding-top:5px">
                    <input type="text" id="txtAskingDate" name="txtAskingDate"  class="l-text l-text-editing"  style=" float:left;" />
            </td>
        </tr>
        <tr>
            <th style=" padding-top:5px">任务单号:</th>
            <td align="left"  class="l-table-edit-td float2013" style=" padding-top:5px">
            ...
            <td>
              ...
              <td>    
                 <input type="button" id="btnGet" name="btnGet" value="生 成"  class="l-button l-button-submit"  style="display:inline-block; float:left; margin-left:15px;" />
              </td>
        </tr>
        <tr id="trSendDept" style="display:none">
            <th style=" padding-top:5px;padding-left:5px;">任务接收:</th>
            <td align="left"  class="l-table-edit-td" style=" padding-top:5px">
                <input type="text" id="txtSendDept" name="txtSendDept"  class="l-text l-text-editing"  /></td>
        </tr>
    </table>
    </div>
