...
/// 现场主管审核
/// </summary>
public partial class Channels_Mis_MonitoringPlan_TaskSampleAuditList_QHD : PageBase
{
    ...
    /// <returns></returns>
    [WebMethod]
    public static string getStatusByTaskID(string strTaskID)
    {
        if (new TMisMonitorResultLogic().isAllSend(strTaskID, "50", false))
            return "已完成";
        else
            return "未完成";
    }
