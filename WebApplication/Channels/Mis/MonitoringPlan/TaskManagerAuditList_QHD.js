...
$(document).ready(function () {
    ...
    maingrid1 = $("#maingrid1").ligerGrid({
        ...
        pageSize: 25,
        url: 'MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strType=true&strQcStatus=M11',
    ...
    function TopOpen() {
        ...
        if (rowSelected == null) {
            ...
            top.f_addTab("tabManagerAuditSample", '技术室主管审核', "../Channels/Mis/Monitor/sampling/QHD/ManagerAuditSampling.aspx?type=ModifTaskSampleDutyUser&planid=" + rowSelected.ID + "&strTask_Id=" + rowSelected.CONTRACT_ID + "&strQCStatus=" + rowSelected.QC_STATUS + "&strWorkTask_Id=" + rowSelected.TASK_ID + "&strDept=" + rowSelected.STATE);
