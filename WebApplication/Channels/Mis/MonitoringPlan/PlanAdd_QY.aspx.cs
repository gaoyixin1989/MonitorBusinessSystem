...
public partial class Channels_Mis_MonitoringPlan_PlanAdd_QY : PageBase
{
    public string strTest_Type="";
    protected void Page_Load(object sender, EventArgs e)
    {
        string strResult = "";
        if (!string.IsNullOrEmpty(Request.QueryString["type"]) && Request.QueryString["type"] == "doPlan")
        {
            strResult = doPlanTask(Request.QueryString["strPlanId"]);
