...
$(document).ready(function () {
    ...
    maingrid1 = $("#maingrid1").ligerGrid({
        ...
        pageSize: 25,
        url: 'MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strQcStatus=1&strType=true',
        //            url: 'MonitoringPlan.ashx?action=GetPendingPlanListForAnyTaskStatus&strQcStatus=2&strType=true',
        ...
        toolbar: { items: [
            ...
            //                { line: true },
               {id: 'sample', text: '质控设置', click: TopOpen, icon: 'up' },
                { line: true },
    ...
    function TopOpen() {
        ...
        if (rowSelected == null) {
            ...
            top.f_addTab("tabSample_QCStep", '样品质控设置', "../Channels/Mis/Monitor/sampling/SamplingTaskAllocation_QCStep.aspx?type=ModifTaskSampleDutyUser&planid=" + rowSelected.ID + "&strTask_Id=" + rowSelected.CONTRACT_ID + "&strQCStatus=" + rowSelected.QC_STATUS + "&strWorkTask_Id=" + rowSelected.TASK_ID);
        }
    }
    ...
    function showDetailSrh1() {
        ...
        function search1() {
            ...
            var url = "MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strQcStatus=1&strType=true&strProjectName=" + SEA_PROJECT_NAME + "&strContractCode=" + SEA_CONTRACT_CODE + "&strContratYear=" + SEA_CONTRACT_YEAR_OP + "&strContractType=" + SEA_CONTRACT_TYPE_OP + "&strCompanyNameFrim=" + SEA_TEST_COMPANYNAME + "&strAreaIdFrim=" + SEA_AREA + "&strTickeNum=" + encodeURI(SEA_TICKET_NUM) + "&strDate=" + SEA_PLANDATE;
