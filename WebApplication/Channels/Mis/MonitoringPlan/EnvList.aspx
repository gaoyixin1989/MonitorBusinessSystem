<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_MonitoringPlan_EnvList" Codebehind="EnvList.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="EnvList.js"></script>
...
<form id="form1" runat="server">
    ...
    <div id="navtab1" style="width: 99%; hidden; border:1px solid #A3C0E8; ">
        <div tabid="home" title="待办理任务"  lselected="true" contextmenu="false" >
