<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_MonitoringPlan_TaskPlanListView" Codebehind="TaskPlanListView.aspx.cs" %>
...
<head id="Head1" runat="server">
   ...
   <script src="../../../Controls/ligerui/lib/ligerUI/js/plugins/ligerDrag.js" type="text/javascript"></script>
    ...
    <script src="../../../Controls/ligerui/lib/draggable.js" type="text/javascript"></script>
      <script src="TaskPlanListView.js" type="text/javascript"></script>
    <title></title>
</head>
