...
$(document).ready(function () {
    ...
    maingrid1 = $("#maingrid1").ligerGrid({
        ...
        pageSize: 25,
        //url: 'MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strType=true&strState=02&strQcStatus=3|8&strHasDone=0|1',
        url: 'MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strType=true&strQcStatus=M13',
    ...
    function TopOpen() {
        ...
        if (rowSelected == null) {
            ...
            top.f_addTab("tabManagerAuditSample", '分析室主管审核', "../Channels/Mis/Monitor/sampling/QHD/ManagerAuditSampling.aspx?type=ModifTaskSampleDutyUser&planid=" + rowSelected.ID + "&strTask_Id=" + rowSelected.CONTRACT_ID + "&strQCStatus=" + rowSelected.QC_STATUS + "&strWorkTask_Id=" + rowSelected.TASK_ID + "&strDept=" + rowSelected.STATE);
