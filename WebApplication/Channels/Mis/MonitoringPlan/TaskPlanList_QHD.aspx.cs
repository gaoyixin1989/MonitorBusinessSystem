...
public partial class Channels_Mis_MonitoringPlan_TaskPlanList_QHD : PageBase
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        //TMisContractCompanyVo objContractCompanyVo = new TMisContractCompanyLogic().Details(objContract.TESTED_COMPANY_ID);
        //TBaseCompanyInfoVo objCompany = new TBaseCompanyInfoLogic().Details(objContractCompanyVo.COMPANY_ID);
