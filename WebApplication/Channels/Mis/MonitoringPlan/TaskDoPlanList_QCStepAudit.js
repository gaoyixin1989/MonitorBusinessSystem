...
$(document).ready(function () {
    ...
    maingrid1 = $("#maingrid1").ligerGrid({
        ...
        pageSize: 25,
        url: 'MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strQcStatus=4&strType=true',
    ...
    function TopOpen() {
        ...
        if (rowSelected == null) {
            ...
            top.f_addTab("tabSample_QCStepAudit", '采样前质控审核', "../Channels/Mis/Monitor/sampling/SamplingTaskAllocation_QCStepAudit.aspx?type=ModifTaskSampleDutyUser&planid=" + rowSelected.ID + "&strTask_Id=" + rowSelected.CONTRACT_ID + "&strQCStatus=" + rowSelected.QC_STATUS + "&strWorkTask_Id=" + rowSelected.TASK_ID + "&strTaskType=" + rowSelected.TASK_TYPE);
        }
    }
    ...
    function showDetailSrh1() {
        ...
        function search1() {
            ...
            var url = "MonitoringPlan.ashx?action=GetPendingPlanListDoTask&strQcStatus=4&strType=true&strProjectName=" + SEA_PROJECT_NAME + "&strContractCode=" + SEA_CONTRACT_CODE + "&strContratYear=" + SEA_CONTRACT_YEAR_OP + "&strContractType=" + SEA_CONTRACT_TYPE_OP + "&strCompanyNameFrim=" + SEA_TEST_COMPANYNAME + "&strAreaIdFrim=" + SEA_AREA + "&strTickeNum=" + encodeURI(SEA_TICKET_NUM) + "&strDate=" + SEA_PLANDATE;
