<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_MonitoringPlan_EnvPendingDoTaskEx" Codebehind="EnvPendingDoTaskEx.aspx.cs" %>
...
<link href="../../../Controls/ligerui/lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
    ...
    <script src="EnvPendingDoTaskEx.js" type="text/javascript"></script>
    ...
    <table>
        <tr>
            ...
            <td align="left"  style="padding:3px "  class="l-table-edit-td" colspan="4">
                <input type="text" id="txtProjectName" name="txtProjectName" style="width:415px"  class="l-text l-text-editing"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left"  style="padding:3px"   class="l-table-edit-td">
               <input type="text" id="txtTASK_CODE" name="txtTASK_CODE"  class="l-text l-text-editing" style="width:200px" disabled="disabled" />
            </td>
