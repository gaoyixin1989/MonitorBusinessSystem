<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_MonitoringPlan_ContractPlanAdd" Codebehind="ContractPlanAdd.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="ContractPlanAdd.js" type="text/javascript"></script>
...
<body>
    ...
    <table>
    <tr >
    <td align="right"  class="l-table-edit-td" style=" padding-top:5px">&nbsp;&nbsp;&nbsp;&nbsp;监测年度: </td>
...
<input type="text" id="Contract_Type" name="Contract_Type"  class="l-text l-text-editing"/>
    ...
    <tr id="trSource">
                    ...
                    <tr id="trEnvTypes" style="display:none">
                    <td align="right"  class="l-table-edit-td" style=" padding-top:5px">&nbsp;&nbsp;&nbsp;&nbsp;环境类别: </td>
                    <td align="left"  class="l-table-edit-td" style=" padding-top:5px">
                        <input type="text" id="EnvTypes" name="EnvTypes"  class="l-text l-text-editing" style="width:200px"/>
                    </td>
                     <td id="tdDmName" align="right"  class="l-table-edit-td" style=" padding-top:5px">&nbsp;&nbsp;断面名称: </td>
                    <td align="left"  class="l-table-edit-td" style=" padding-top:5px">
                        <input type="text" id="DmName" name="DmName"  class="l-text l-text-editing" style="width:200px"/>
                    </td>
                </tr>
    <tr >
