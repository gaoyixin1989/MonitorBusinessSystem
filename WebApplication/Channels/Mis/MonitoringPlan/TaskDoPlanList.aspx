<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_Mis_MonitoringPlan_TaskDoPlanList" Codebehind="TaskDoPlanList.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="TaskDoPlanList.js"></script>
    <title></title>
</head>
<body>
    ...
    <div position="center" title="">
        <div id="navtab1" style="width: 100%; overflow: hidden; border: 1px solid #A3C0E8;">
            <div id="maingrid1" title="待办理预约任务列表">
            </div>
            <div id="maingrid2" title="已办理预约任务列表">
            </div>
        </div>
    </div>
