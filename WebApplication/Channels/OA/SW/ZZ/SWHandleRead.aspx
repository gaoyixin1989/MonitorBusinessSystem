<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_SW_ZZ_SWHandleRead" Codebehind="SWHandleRead.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="SWHandleRead.js" type="text/javascript"></script>
    ...
    <div class="tablelayout">
        ...
        <table  border="0" cellpadding="0" cellspacing="0" class="tableedit mlr8">
            <tr>
                ...
                <td style="width:55px; text-align:right;">来文机关</td>
                <td><asp:TextBox ID="SW_FROM" runat="server" Text=""></asp:TextBox></td>
                <td style="width:55px; text-align:right;">编号</td>
            ...
            <tr >
                <th>
                    传阅人员:                  </th>
                <td align="left"  colspan="5">
                        <input type="text" id="SwReadUserNames" runat="server" style="width:450px;" onclick="javascript:return ACCEPT_REALNAMES_select('SwReadUserNames','Hid_SwReadUserIDs');" />
                        <input id="Hid_SwReadUserIDs" runat="server" type="text" style="display:none;" />
                </td>
            </tr>
             <tr>
                <th>
