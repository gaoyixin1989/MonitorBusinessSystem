<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_SW_ZZ_SWAllList" Codebehind="SWAllList.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="SWAllList.js" type="text/javascript"></script>
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <form id="form1" runat="server" style="display:none;">
         ...
         <asp:Button ID="btnPrintSW" runat="server" Text="Button" onclick="btnPrintSW_Click" />
    </form>
