<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_SW_SWEdit" Codebehind="SWEdit.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="SWEdit.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="tabletop "> 原文编号：<asp:TextBox ID="FROM_CODE" runat="server" Text=""></asp:TextBox><p> 日期：<asp:Label ID="SW_REG_DATE" runat="server"></asp:Label>
		</p></div>
        <table  border="0" cellpadding="0" cellspacing="0" class="tableedit mlr8">
            ...
            <tr>
                <th >
                    来文单位  </th>
                <td >
                    <asp:TextBox ID="SW_FROM" runat="server" Text="" style="width:160px;"></asp:TextBox>                </td>
            ...
            <tr>
                <th >
                    签收人  </th>
                <td >
                    <asp:TextBox ID="SW_SIGN_ID" runat="server" Text="" style="width:160px;"></asp:TextBox>                </td>
                <td style="  text-align:right;" >
                    签收日期  </td>
                <td >
                    <asp:TextBox ID="SW_SIGN_DATE" runat="server" Text="" style="width:100px;"></asp:TextBox>                </td>
                <td style="  text-align:right;">收文字号</td>
                <td>
                    <asp:TextBox ID="SW_CODE" runat="server" Text="" style="width:100px;"></asp:TextBox>                </td>
            </tr>
