...
public partial class Channels_OA_EmployeTrain_EmployeTrain_Year : PageBaseForWF, IWFStepRules
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(task_id))
        {
            ...
            //注册名称
            wfControl.ServiceName = DateTime.Now.ToString("yyyy")+"年度培训登记表(主题:"+this.hidTaskProjectName.Value.ToString()+")";
        }
    }
    /// <summary>
    /// 获取页面隐藏域参数
    ...
    void IWFStepRules.CreatAndRegisterBusinessData()
    {
        ...
        if (!String.IsNullOrEmpty(task_id))
        {
            ...
            {
                wfControl.SaveInstStepServiceData("年度员工培训ID", "task_id", task_id, "1");
            }
            else
            {
