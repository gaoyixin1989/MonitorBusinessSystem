<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_EmployeTrain_EmployeTrain_Year" Codebehind="EmployeTrain_Year.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="EmployeTrain_Year.js" type="text/javascript"></script>
...
<td align="left" colspan="3"  >
<div id="divDownLoad" style="float:left; margin-right:10px; width:100px; overflow:hidden; display:inline; " >
<a id="btnFiledownLoad" href="#" >点击查看下载附件</a>
</div>
 <div id="divFileUp" style="float:left; margin-right:10px; width:100px; overflow:hidden; display:inline; "" >
