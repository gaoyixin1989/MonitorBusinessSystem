<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_EmployeTrain_EmployeTrain_LeaderAduit" Codebehind="EmployeTrain_LeaderAduit.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="EmployeTrain_LeaderAduit.js" type="text/javascript"></script>
...
<td align="left" colspan="11" class="l-minheight" >
...
<td align="left" colspan="11" class="l-minheight" style=" padding-top:5px">
...
<td align="left" >
<input  type="button" id="PageBtnSave" value="保存" class="l-button l-button-submit" /></td>
<td align="left" >
    &nbsp;</td>
<td align="left" >
    &nbsp;</td>
