<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_Part_ZZ_FillMaterials" Codebehind="FillMaterials.aspx.cs" %>
...
<head   id="Head1" runat="server">
    ...
    <script src="FillMasterial.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
     	<h1 class="h12013">填 报 领 料 申 请 单</h1>
...
<textarea cols="100" rows="8" class="l-textarea" id="TestOption" style="width:600px;  padding:2px; margin-left:0; line-height:20px;" ></textarea> 
</td>
</tr>
<tr id="trTestPInfor">
<th>
...
<td align="left" colspan="8"  class="l-minheight">
<textarea cols="100" rows="8" class="l-textarea" id="TechOption" style="width:600px;  padding:2px; margin-left:0; line-height:20px;" ></textarea>
</td>
</tr>
<tr id="trTechInfor">
<th>
...
<input type="hidden"  id="hidTaskId_Load" runat="server" />
</div>
    </form>
</body>
</html>
