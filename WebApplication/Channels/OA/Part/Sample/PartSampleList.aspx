<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_Part_Sample_PartSampleList" Codebehind="PartSampleList.aspx.cs" %>
...
<head runat="server">
    ...
    <script src="PartSampleList.js" type="text/javascript"></script>

    <title></title>
</head>
<body style="padding: 0px; overflow: hidden;">
    <div id="navtab1" style="width: 100%; overflow: hidden; border: 1px solid #A3C0E8;">
        <div tabid="home" title="未领完列表" lselected="true" contextmenu="false">
