<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="Channels_OA_Part_Sample_SampleCollarList" Codebehind="SampleCollarList.aspx.cs" %>
...
<head runat="server">
    ...
    <script src="SampleCollarList.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
    <div  style="width: 100%; height:100%; overflow: hidden; border: 1px solid #A3C0E8;">
    <div id="divPartInfo">
    </div></div>
    ...
    <div style="display:none;">
        <input type="hidden" id="hidExportData" runat="server" />
