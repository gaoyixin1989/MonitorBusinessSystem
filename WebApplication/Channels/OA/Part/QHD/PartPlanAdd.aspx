<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_Part_QHD_PartPlanAdd" Codebehind="PartPlanAdd.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="PartPlanAdd.js" type="text/javascript"></script>
    <style type="text/css">
        .l-minheight div
        {
            height: 90px;
    ...
    <script type="text/javascript">
        function PD() {
            ...
            if (keshi == "1") {
                window.location = "../PartPlanAcceptDetail.aspx?WF_ID=PARTPLAN&keshi=1";
            }
            if (keshi == "2") {
                window.location = "../PartPlanAcceptDetail.aspx?WF_ID=PARTPLAN&keshi=2";
            }
        }
    </script>
    ...
    <div class="tablelayout">
        ...
        <table cellspacing="0" cellpadding="0" align="center" class="tableedit mlr8">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="PlanPerson" name="PlanPerson" class="l-text l-text-editing"
                        style="width: 200px;" />
                </td>
            </tr>
            <tr>
                ...
                <td align="left">
                    <input type="text" id="PlanDate" name="PlanDate" class="l-text l-text-editing" style="width: 200px;
                        text-align: left;" />
                </td>
                <th>
                    &nbsp;
            ...
            <tr id="trTechOption">
                ...
                <td align="left" colspan="8" class="l-minheight">
                    <textarea cols="100" rows="5" class="l-textarea" id="TechOption" style="width: 600px;
            ...
            <tr id="trTechInfor">
                ...
                <td>
                    <input type="text" id="TechDate" name="TechDate" class="l-text l-text-editing" style="width: 200px;" />
                </td>
            </tr>
            <tr id="trAdminOption">
                <th>
                ...
                <td align="left" colspan="8" class="l-minheight">
                    <textarea cols="100" rows="5" class="l-textarea" id="AdminOption" style="width: 600px;
                        padding: 2px; margin-left: 0; line-height: 20px;"></textarea>
                </td>
            </tr>
            <tr id="trAdminInfor">
                ...
                <td align="left">
                    <input type="text" id="AdminName" name="AdminName" class="l-text l-text-editing"
                        style="width: 200px" />
                </td>
                <th>
                    日期：
                ...
                <td>
                    <input type="text" id="AdminDate" name="AdminDate" class="l-text l-text-editing"
                        style="width: 200px;" />
                </td>
            </tr>
        </table>
