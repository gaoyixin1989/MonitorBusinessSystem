<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="Channels_OA_Part_QHD_PartOffice_TechAduit" Codebehind="PartOffice_TechAduit.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="PartOffice_TechAduit.js" type="text/javascript"></script>
    <style type="text/css">
        .l-minheight div
        {
            height: 90px;
