...
public partial class Channels_OA_Part_QHD_PartTestAdd : PageBaseForWF, IWFStepRules
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //注册编号
            wfControl.ServiceCode = "SY" + DateTime.Now.ToString("yyyyMMddHHmmss");
            //注册名称
            wfControl.ServiceName = strTaskProjectName+"实验用品申请单";
        }
    }
    /// <summary>
    /// 获取页面隐藏域参数
