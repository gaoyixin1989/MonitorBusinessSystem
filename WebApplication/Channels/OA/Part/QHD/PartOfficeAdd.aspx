<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_Part_QHD_PartOfficeAdd" Codebehind="PartOfficeAdd.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="PartOfficeAdd.js" type="text/javascript"></script>
    <style type="text/css">
        .l-minheight div
        {
            height: 90px;
...
<body>
    ...
    <input type="button" value="返回" id="btn_Back" name="btn_Back" class="l-button l-button-submit"
                style="display: inline-block; margin-top: 8px;" onclick="javascript:self.location='PartPurchaseList.aspx';" />
 </div>
    <div>
