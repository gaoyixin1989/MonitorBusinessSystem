<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_Part_GetSelectPartList" Codebehind="GetSelectPartList.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../Controls/ligerui/lib/draggable.js" type="text/javascript"></script>
      <script src="GetSelectPartList.js" type="text/javascript"></script>
    <title></title>
</head>
<body  style="padding: 0px; overflow: hidden; width: 100%; height: 100%;">
<form id="form1"  runat="server">
<div class="l-loading" style="display:block" id="pageloading"></div>
<div id="divPartInfo" ></div>
