<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_File_FileManageSearchEx" Codebehind="FileManageSearchEx.aspx.cs" %>
...
<head runat="server">
    ...
    <script src="../../../Controls/ligerui/lib/ligerUI/js/plugins/ligerTab.js" type="text/javascript"></script>
        <script src="FileManageSearchEx.js" type="text/javascript"></script>
            <style type="text/css">
...
<body style="padding:0px; overflow:hidden;">
    ...
    <div id="navtab1" style="width: 100%;overflow:hidden; border:1px solid #A3C0E8; ">
        <div tabid="home" title="档案审核"  lselected="true" contextmenu="false" >
