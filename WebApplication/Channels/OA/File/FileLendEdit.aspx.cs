...
/// 创建人：邵世卓
/// </summary>
public partial class Channels_OA_File_FileLendEdit : PageBase
{
    ...
    public string frmAdd()
    {
        ...
        objArchivesBorrow.LENT_OUT_STATE = "0";
        ...
        if (isSuccess)
        {
            WriteLog("添加归还记录", "", LogInfo.UserInfo.USER_NAME + "添加归还记录" + objArchivesBorrow.ID + "成功！");
        }
    ...
    protected bool IsBorrow()
    {
        ...
        {
            return drBorrow[0]["LENT_OUT_STATE"].ToString() == "0" ? true : false;
        }
        return false;
    }
}