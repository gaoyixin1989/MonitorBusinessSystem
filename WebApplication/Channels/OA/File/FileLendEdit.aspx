<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_File_FileLendEdit" Codebehind="FileLendEdit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#divEdit").ligerForm({
                ...
                { display: "归还人", name: "BORROWER_NAME", newline: false, type: "text" },
                { name: "BORROWER", newline: false, type: "hidden" },
                { display: "归还时间", name: "LOAN_TIME", newline: true, type: "date" },
                { display: "备注", name: "REMARK", newline: true, type: "textarea", width: 450 }
                ]
            });
            $("#BORROWER").attr("validate", "[{required:true,msg:'请选择归还人'}]");
        ...
        '关闭', onclick: function (item, dialog) { dialog.close(); }
            ...
            if ($("#formId").val() != "") {
                $.ajax({
                    ...
                    async: false,
                    type: "POST",
                    url: "FileLendEdit.aspx?type=loadData&id=" + $("#formId").val(),
        ...
        function DataSave() {
            ...
            var options = {
                ...
                url: "FileLendEdit.aspx?document_id=" + $("#document_id").val(),
                type: "post"
            };
            //验证
            if (!$("#form1").validate())
...
<body>
    <form id="form1" action="FileLendEdit.aspx" method="post">
    <div id="divEdit">
    </div>
