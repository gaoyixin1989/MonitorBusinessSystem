...
public partial class Channels_OA_PersonnelFile_Administration_ExamInfor_Admin : PageBaseForWF, IWFStepRules
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //注册编号
            wfControl.ServiceCode ="XZ" + DateTime.Now.ToString("yyyyMMddHHmmss");
            //注册名称
    ...
    void IWFStepRules.CreatAndRegisterBusinessData()
    {
        ...
        if (!String.IsNullOrEmpty(task_id))
        {
            ...
            {
                wfControl.SaveInstStepServiceData("事业单位人员人事考核ID(单位审核)", "task_id", task_id, "1");
            }
            else
            {
