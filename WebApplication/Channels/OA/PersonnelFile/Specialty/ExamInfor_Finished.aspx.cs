...
public partial class Channels_OA_PersonnelFile_Specialty_ExamInfor_Finished : PageBaseForWF, IWFStepRules
{
    ...
    void IWFStepRules.CreatAndRegisterBusinessData()
    {
        ...
        if (!String.IsNullOrEmpty(task_id))
        {
            ...
            {
                wfControl.SaveInstStepServiceData("专业技术人员人事考核ID(归档)", "task_id", task_id, "3");
            }
            else
            {
