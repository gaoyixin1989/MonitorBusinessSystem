<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_PersonnelFile_Specialty_ExamInfor_Specalty" Codebehind="ExamInfor_Specalty.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../../Controls/ligerui/lib/ligerUI/js/plugins/ligerTab.js" type="text/javascript"></script>
        ...
        <script src="ExamInfor_Specalty.js" type="text/javascript"></script>
    <title></title>
</head>
<body>
   ...
   <div position="top"> 
    ...
    <div position="center" style=" height:300px">
        <div id="OptionDiv" style=" display:none; height:300px">
