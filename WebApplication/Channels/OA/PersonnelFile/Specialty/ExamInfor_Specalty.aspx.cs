...
public partial class Channels_OA_PersonnelFile_Specialty_ExamInfor_Specalty : PageBaseForWF, IWFStepRules
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //注册编号
            wfControl.ServiceCode = "ZJ" + DateTime.Now.ToString("yyyyMMddHHmmss");
            //注册名称
    ...
    void IWFStepRules.CreatAndRegisterBusinessData()
    {
        ...
        if (!String.IsNullOrEmpty(task_id))
        {
            ...
            {
                wfControl.SaveInstStepServiceData("专业技术人员人事考核ID", "task_id", task_id, "1");
            }
            else
            {
