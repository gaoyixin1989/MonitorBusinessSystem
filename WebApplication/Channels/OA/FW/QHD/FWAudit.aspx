<%@ Page Language="C#" AutoEventWireup="True" Inherits="n4.Channels_OA_FW_QHD_FWAudit" Codebehind="FWAudit.aspx.cs" %>
...
<body>
    ...
    <div class="tablelayout">
        <div class="tabletop ">
            编号：<asp:Label ID="YWNO" runat="server" Text=""></asp:Label><p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tableedit mlr8">
            ...
            <tr>
                ...
                <td style="width: 80px;">
                    <asp:Label ID="DRAFT_ID" runat="server" Text=""></asp:Label>
                </td>
                <td style="text-align: right; width: 55px;">
                    紧急程度
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:Label ID="FWNO" runat="server" Text="" Style="width: 200px;"></asp:Label>
                </td>
            </tr>
            <tr>
                <th>
