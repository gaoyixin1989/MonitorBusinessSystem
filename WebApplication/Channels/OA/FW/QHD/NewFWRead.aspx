<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_SW_QHD_NewFWRead" Codebehind="NewFWRead.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="NewFWRead.js" type="text/javascript"></script>

    <title></title>
</head>
<body style="padding: 0px; overflow: hidden;">
    <div id="navtab1" style="width: 100%; overflow: hidden; border: 1px solid #A3C0E8;">
        <div tabid="home" title="发文阅办" lselected="true" contextmenu="false">
            <div id="oneGrid" style="margin: 0px;">
            </div>
        </div>
    </div>
    <%--<input type="hidden" id="hidFH" value="0" runat="server" />--%>
</body>
</html>
