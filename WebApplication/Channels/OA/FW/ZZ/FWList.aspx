<%@ Page Language="C#" AutoEventWireup="True" Inherits="n9.Channels_OA_FW_QHD_FWList" Codebehind="FWList.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="FWList.js" type="text/javascript"></script>
    <style type="text/css">
        #menu1, .l-menu-shadow
        {
            top: 10px;
...
<body style="padding: 0px; overflow: hidden;" runat="server">
    <div class="l-loading" style="display: block" id="pageloading">
        ...
        <div  id="layout">
            ...
            <div id="maingrid" style="margin: 0px;">
            </div>
        </div>
