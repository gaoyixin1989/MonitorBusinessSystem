<%@ Page Language="C#" AutoEventWireup="True" Inherits="Channels_OA_FW_ZZ_FWAllList" Codebehind="FWAllList.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="FWAllList.js" type="text/javascript"></script>
    <style type="text/css">
        #menu1, .l-menu-shadow
        {
            top: 10px;
...
<body id="Body1" style="padding: 0px; overflow: hidden;" runat="server">
    <div class="l-loading" style="display: block" id="pageloading">
    </div>

        <div  id="layout">
            <div id="maingrid1" style="margin: 0px;">
            </div>
        </div>
    ...
    <asp:Button ID="btnExport" runat="server" OnClick="btnImport_Click" />
        <%--表单查询--%>
        <div id="searchDiv" style="display: none;">
        <div id="searchForm"> </div></div>
