...
function GetSayHelloMsg() {
    ...
    str = str + "今天是" + d.getFullYear() + "年" + (d.getMonth() + 1) + "月" + d.getDate() + "日";
    str = str + "，阴历" + GetLunarDateString(d);

    if (d.getDay() == 0) str = str + "，星期日";
    if (d.getDay() == 1) str = str + "，星期一";
    if (d.getDay() == 2) str = str + "，星期二";
    if (d.getDay() == 3) str = str + "，星期三";
    if (d.getDay() == 4) str = str + "，星期四";
    if (d.getDay() == 5) str = str + "，星期五";
    if (d.getDay() == 6) str = str + "，星期六";
