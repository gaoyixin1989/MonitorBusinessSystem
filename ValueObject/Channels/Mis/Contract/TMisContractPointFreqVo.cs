...
namespace i3.ValueObject.Channels.Mis.Contract
{
    ...
    /// 创建人：潘德军
    /// </summary>
    public class TMisContractPointFreqVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_MIS_CONTRACT_POINT_FREQ_TABLE = "T_MIS_CONTRACT_POINT_FREQ";
        //静态字段引用
        /// <summary>
        /// ID
        /// </summary>
        ...
        public TMisContractPointFreqVo()
        {
            this.ID = "";
            this.CONTRACT_ID = "";
