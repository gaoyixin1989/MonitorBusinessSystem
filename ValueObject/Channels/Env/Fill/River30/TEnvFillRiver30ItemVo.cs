...
namespace i3.ValueObject.Channels.Env.Fill.River30
{
    ...
    /// time:2013-6-25
    /// </summary>
    public class TEnvFillRiver30ItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_RIVER30_ITEM_TABLE = "T_ENV_FILL_RIVER30_ITEM";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
