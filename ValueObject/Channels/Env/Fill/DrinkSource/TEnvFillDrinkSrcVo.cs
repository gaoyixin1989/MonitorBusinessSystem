...
namespace i3.ValueObject.Channels.Env.Fill.DrinkSource
{
    ...
    /// 创建人：魏林
    /// </summary>
    public class TEnvFillDrinkSrcVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_DRINK_SRC_TABLE = "T_ENV_FILL_DRINK_SRC";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
