...
namespace i3.ValueObject.Channels.Env.Fill.AirKS
{
    ...
    /// 创建人：刘静楠
    /// </summary>
    public class TEnvFillAirksItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_AIRKS_ITEM_TABLE = "T_ENV_FILL_AIRKS_ITEM";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
