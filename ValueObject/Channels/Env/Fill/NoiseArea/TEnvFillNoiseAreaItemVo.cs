...
namespace i3.ValueObject.Channels.Env.Fill.NoiseArea
{
    ...
    /// 创建人：魏林
    /// </summary>
    public class TEnvFillNoiseAreaItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_NOISE_AREA_ITEM_TABLE = "T_ENV_FILL_NOISE_AREA_ITEM";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        public TEnvFillNoiseAreaItemVo()
        {
            this.ID = "";
            this.FILL_ID = "";
            this.ITEM_ID = "";
