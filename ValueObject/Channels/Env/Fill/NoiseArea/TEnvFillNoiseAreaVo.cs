...
namespace i3.ValueObject.Channels.Env.Fill.NoiseArea
{
    ...
    /// 创建人：魏林
    /// </summary>
    public class TEnvFillNoiseAreaVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_NOISE_AREA_TABLE = "T_ENV_FILL_NOISE_AREA";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
