...
namespace i3.ValueObject.Channels.Env.Fill.NoiseArea
{
    /// <summary>
    /// 功能：区域环境噪声数据填报
    /// 创建日期：2013-06-26
    /// 创建人：魏林
    /// </summary>
    public class TEnvFillNoiseAreaSummaryVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_NOISE_AREA_SUMMARY_TABLE = "T_ENV_FILL_NOISE_AREA_SUMMARY";
        //静态字段引用
        /// <summary>
        /// ID
        /// </summary>
        ...
        /// 城区人口
        /// </summary>
        public static string PEOPLE_COUNT_FIELD = "PEOPLE_COUNT";
        /// <summary>
        /// 监测起始月
        /// </summary>
        ...
        /// 城区人口密度
        /// </summary>
        public static string PEOPLE_DENSITY_FIELD = "PEOPLE_DENSITY";
        /// <summary>
        /// 建成区面积
        /// </summary>
        ...
        public TEnvFillNoiseAreaSummaryVo()
        {
            this.ID = "";
            this.YEAR = "";
            this.VALID_COUNT = "";
