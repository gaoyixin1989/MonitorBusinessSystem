...
namespace i3.ValueObject.Channels.Env.Fill.Air30
{
    ...
    /// 创建人：刘静楠
    /// </summary>
    public class TEnvFillAir30ItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_FILL_AIR30_ITEM_TABLE = "T_ENV_FILL_AIR30_ITEM";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
