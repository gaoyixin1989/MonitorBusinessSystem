...
namespace i3.ValueObject.Channels.Env.Point.NoiseFun
{
    /// <summary>
    /// 功能：功能区噪声
    /// 创建日期：2013-06-15
    /// 创建人：魏林
    /// </summary>
    public class TEnvPNoiseFunctionVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_NOISE_FUNCTION_TABLE = "T_ENV_P_NOISE_FUNCTION";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// 标准昼间
        /// </summary>
        public static string STANDARD_LIGHT_FIELD = "STANDARD_LIGHT";
        /// <summary>
        /// 标准夜间
        /// </summary>
        public static string STANDARD_NIGHT_FIELD = "STANDARD_NIGHT";
        /// <summary>
        /// 经度（度）
        /// </summary>
