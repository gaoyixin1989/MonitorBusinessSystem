...
namespace i3.ValueObject.Channels.Env.Point.PayFor
{
    /// <summary>
    /// 功能：生态补偿
    /// 创建日期：2013-06-14
    /// 创建人：魏林
    /// </summary>
    public class TEnvPPayforVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_PAYFOR_TABLE = "T_ENV_P_PAYFOR";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// 上游断面
        /// </summary>
        public static string UP_POINT_FIELD = "UP_POINT";
        /// <summary>
        /// 所在地区ID（字典项）
        /// </summary>
