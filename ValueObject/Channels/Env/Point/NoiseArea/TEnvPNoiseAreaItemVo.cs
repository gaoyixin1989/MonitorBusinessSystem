...
namespace i3.ValueObject.Channels.Env.Point.NoiseArea
{
    ...
    /// 创建人：魏林
    /// </summary>
    public class TEnvPNoiseAreaItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_NOISE_AREA_ITEM_TABLE = "T_ENV_P_NOISE_AREA_ITEM";
        //静态字段引用
        /// <summary>
        /// ID
        /// </summary>
