...
namespace i3.ValueObject.Channels.Env.Point.Sulfate
{
    ...
    /// 创建日期：2013-06-15
    /// 创建人：ljn
    public class TEnvPAlkaliItemVo : i3.Core.ValueObject.ObjectBase
    {
        #region 静态引用
        //静态表格引用
        /// <summary>
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_ALKALI_ITEM_TABLE = "T_ENV_P_ALKALI_ITEM";
        //静态字段引用
        /// <summary>
        /// ID
        /// </summary>
