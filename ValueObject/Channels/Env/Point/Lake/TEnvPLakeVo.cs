...
namespace i3.ValueObject.Channels.Env.Point.Lake
{
    /// <summary>
    /// 功能：湖库
    /// 创建日期：2013-06-13
    /// 创建人：魏林
    /// </summary>
    public class TEnvPLakeVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_LAKE_TABLE = "T_ENV_P_LAKE";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// 水库ID（字典项）
        /// </summary>
        public static string LAKE_ID_FIELD = "LAKE_ID";
        /// <summary>
        /// 水质目标ID（字典项）
        /// </summary>
