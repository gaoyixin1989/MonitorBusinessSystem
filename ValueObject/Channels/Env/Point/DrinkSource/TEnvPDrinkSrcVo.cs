...
namespace i3.ValueObject.Channels.Env.Point.DrinkSource
{
    /// <summary>
    /// 功能：魏林
    /// 创建日期：2013-06-07
    /// 创建人：饮用水源地（湖库、河流）
    /// </summary>
    public class TEnvPDrinkSrcVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_DRINK_SRC_TABLE = "T_ENV_P_DRINK_SRC";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// 水期
        /// </summary>
        public static string WATER_PERIOD_FIELD = "WATER_PERIOD";
        /// <summary>
        /// 所属水系
        /// </summary>
        public static string RIVER_SYSTEM_FIELD = "RIVER_SYSTEM";
        /// <summary>
        /// 水源地性质
        /// </summary>
        public static string WATER_PROPERTY_FIELD = "WATER_PROPERTY";
        /// <summary>
        /// 断面性质ID（字典项）
        /// </summary>
