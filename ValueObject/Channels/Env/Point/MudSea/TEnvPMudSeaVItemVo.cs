...
namespace i3.ValueObject.Channels.Env.Point.MudSea
{
    ...
    /// 创建人：魏林
    /// </summary>
    public class TEnvPMudSeaVItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_MUD_SEA_V_ITEM_TABLE = "T_ENV_P_MUD_SEA_V_ITEM";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
