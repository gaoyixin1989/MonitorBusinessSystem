...
namespace i3.ValueObject.Channels.Env.Point.RiverTarget
{
    ...
    /// 创建人：魏林
    /// </summary>
    public class TEnvPRiverTargetVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_RIVER_TARGET_TABLE = "T_ENV_P_RIVER_TARGET";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
