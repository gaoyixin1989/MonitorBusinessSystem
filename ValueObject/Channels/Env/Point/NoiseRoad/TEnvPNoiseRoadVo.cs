...
namespace i3.ValueObject.Channels.Env.Point.NoiseRoad
{
    /// <summary>
    /// 功能：道路交通噪声
    /// 创建日期：2013-06-15
    /// 创建人：魏林
    /// </summary>
    public class TEnvPNoiseRoadVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_NOISE_ROAD_TABLE = "T_ENV_P_NOISE_ROAD";
        //静态字段引用
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// 路段名称
        /// </summary>
        public static string ROAD_NAME_FIELD = "ROAD_NAME";
        /// <summary>
        /// 测点编号
        /// </summary>
        ...
        /// 路段长度
        /// </summary>
        public static string ROAD_LENGTH_FIELD = "ROAD_LENGTH";
        /// <summary>
        /// 路段宽度
        /// </summary>
        public static string ROAD_WIDTH_FIELD = "ROAD_WIDTH";
        /// <summary>
        /// 经度（度）
        /// </summary>
