...
namespace i3.ValueObject.Channels.Env.Point.Seabath
{
    ...
    /// 创建人：刘静楠
    /// </summary>
    public class TEnvPSeabathItemVo : i3.Core.ValueObject.ObjectBase
    {
        ...
        /// 对象对应的表格名称
        /// </summary>
        public static string T_ENV_P_SEABATH_ITEM_TABLE = "T_ENV_P_SEABATH_ITEM";
        //静态字段引用
        /// <summary>
        /// ID
        /// </summary>
